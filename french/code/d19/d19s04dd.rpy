...
translate french d19s04dd_f5742d99:
    ...
    mct "On dirait que c'est un état normal pour Daisy... Je me demande ce qui se passe avec elle."
...
translate french d19s04dd_086c4d9a:
    ...
    mc "D'après ce que je vois, tu es complètement caché sous tes draps."

# game/code/d19/d19s04dd.rpy:86
translate french d19s04dd_5cce5225:

    # dd "I'm also kinda... bound."
    dd "Je suis aussi un peu... Lié."
...
translate french d19s04dd_b0a19c5a:
    ...
    dd "Oh, je l'ai fait. Seulement, je me suis un peu enfermé et je n'ai pas la clé."
...
translate french d19s04dd_9d006b53:
    ...
    dd "Je suis complètement nue ici. Menotté et exposé. Je t'attends."

# game/code/d19/d19s04dd.rpy:101
translate french d19s04dd_1fef0b3c:

    # mc "Let me guess. You don't expect me to find the key."
    mc "Laisse-moi deviner. Tu ne t'attends pas à ce que je trouve la clé."
...
translate french d19s04dd_e28205ae:
    ...
    mc "Il y a tellement de délicieuses possibilités."
...
translate french d19s04dd_1d4007a3:
    ...
    mct "Je pourrais jouir comme ça...{w} mais je ne veux pas gâcher cette opportunité."
...
translate french d19s04dd_9b25e971:
    ...
    mct "Oh wow.{w} Je peux vraiment tout monter depuis cette position."
...
translate french d19s04dd_after_4aeb0365:
    ...
    mc "Ça a été une sacrée journée, mais oui.{w} Je pense que tu as été exactement ce que le médecin m'a prescrit."
...
translate french d19s04dd_after_10d88bfc:
    ...
    dd "Je dois te montrer quelque chose."
...
translate french d19s04dd_after_ba9926ba:
    ...
    mc "D'accord, [mcname], sois cool. Il faut expliquer ça calmement et essayer de ne pas traumatiser le pauvre petit gars."
...
translate french d19s04dd_after_407cc883:
    ...
    mc "C'est bon, [d17s06_teddy_name]. Ce que tu viens de voir était parfaitement naturel et-"

# game/code/d19/d19s04dd.rpy:395
translate french d19s04dd_after_5d7f960e:

    # dd "You're so funny."
    dd "Tu es tellement drôle."
...
translate french d19s04dd_plushie_bc1bbcb3:
    ...
    dw "Ne faites pas attention à moi. Continue de forniquer.{w} J'ai juste besoin d'emporter quelques affaires."
...
translate french d19s04dd_plushie_015496d2:
    ...
    dd "*rires* Nous sommes dans une pause fornication, mais j'apprécie ton approbation."
...
translate french d19s04dd_plushie_d3bc127f:
    ...
    mc "*rires* J'ai encore un tour en moi si Dahlia veut se joindre à nous."

# game/code/d19/d19s04dd.rpy:428
translate french d19s04dd_plushie_d92136cd:

    # dw "Not today, but thanks for thinking of me."
    dw "Pas aujourd'hui, mais merci d'avoir pensé à moi."
...
translate french d19s04dd_plushie_296c0a7b:
    ...
    dd "Une liste de choses à faire.{w} Tu sais, une liste de choses que tu veux faire ou réaliser avant...."
...
translate french d19s04dd_plushie_c66f7dcb:
    ...
    mc "C'est un peu sombre{w}, mais je comprends."
...
translate french d19s04dd_plushie_27501e81:
    ...
    dd "Je n'ai jamais fait de parachutisme."
...
translate french d19s04dd_plushie_eaeaf2b7:
    ...
    dd "Je veux dire, j'aimerais d'abord m'entraîner dans un de ces centres de parachutisme en salle. Mais j'ai vraiment envie de sauter d'un avion pour de vrai un jour."
...
translate french d19s04dd_plushie_07df336c:
    ...
    dd "Non, ça doit être Las Vegas.{w} Ça doit être EPIC."
...
translate french d19s04dd_plushie_f1b11b6f:
    ...
    dd "Il y a beaucoup de choses, mais la principale est que je veux parier 1000$ sur un seul tour de roulette."
...
translate french d19s04dd_plushie_2c4f23f0:
    ...
    dw "Je dois admettre que ça figurerait probablement aussi sur ma liste{w} - si je n'étais pas certaine, que je perdrais rapidement 1000$."
...
translate french d19s04dd_plushie_cec53d45:
    ...
    dd "Même si je perds, je l'ai fait.{w} Il y a tellement d'univers possibles."
...
translate french d19s04dd_plushie_1baed6c5:
    ...
    dd "Je suis sûr que dans certains je gagne et dans d'autres je perds, mais dans les deux cas, je suis mieux loti en le faisant."
...
translate french d19s04dd_plushie_8d152bc0:
    ...
    dd "Je voulais te poser une question à ce sujet."
...
translate french d19s04dd_plushie_6fbe08e6:
    ...
    mc "Je sais plus. Je suis presque sûr que c'est Wesley Snipes qui a dit ça dans un film."
...
translate french d19s04dd_plushie_116641dc:
    ...
    dd "Oh, c'est vrai. Attends voir...{w} Film de jeu... Cartes de poker... Candidat mandchou... Heinz 57..."
...
translate french d19s04dd_plushie_04e58636:
    ...
    dd "Très bien, je parierai définitivement sur le noir."
...
translate french d19s04dd_plushie_92c94d21:
    ...
    dd "Ouais, ils paient 2-1. Ça fait une douzaine de numéros, mais techniquement pas un tiers du tableau parce que-"

# game/code/d19/d19s04dd.rpy:577
translate french d19s04dd_plushie_aa0e8881:

    # mc "Second dozen."
    mc "Deuxième douzaine."
...
translate french d19s04dd_plushie_36d2326a:
    ...
    mc "J'ai tout misé sur la deuxième douzaine."
...
translate french d19s04dd_plushie_e50a7106:
    ...
    dd "4 numéros sur le tableau qui se touchent."
...
translate french d19s04dd_plushie_b4dc716b:
    ...
    dd "Par exemple, 16, 17, 19 et 20 sont tous réunis en un seul point."
...
translate french d19s04dd_plushie_ed62b8d3:
    ...
    dd "J'aime un peu la façon dont l'Utah, le Colorado, l'Arizona et le Nouveau-Mexique partagent tous une frontière à quatre coins."
...
translate french d19s04dd_plushie_a8cd830e:
    ...
    mc "Cool. On dirait que ce serait un pari intéressant à faire."
...
translate french d19s04dd_plushie_41fba244:
    ...
    mc "Qu'y a-t-il d'autre sur la liste."
...
translate french d19s04dd_plushie_624056b0:
    ...
    dd "Denali... mais il y a quelque chose dont je voulais te parler."
...
translate french d19s04dd_plushie_2fdd4349:
    ...
    dd "Eh bien, tout ce qui figure sur ma liste à un point en commun."
...
translate french d19s04dd_plushie_2a12181a:
    ...
    dd "Eh bien, deux choses en commun, je suppose."
...
translate french d19s04dd_plushie_8743e204:
    ...
    dd "Quand j'imagine les faire...{w} tu es toujours là avec moi."
...
translate french d19s04dd_plushie_f3d9db4f:
    ...
    dd "Je sais que je ne devrais pas m'attendre..."
...
translate french d19s04dd_plushie_d77da429:
    ...
    mc "Vas-y. Je ne suis pas sûr exactement de ce que tu dis."
...
translate french d19s04dd_plushie_be014f0f:
    ...
    dd "Je veux dire, eh bien...{w} Je sais que je ne suis pas ta seule conquête. Ce n'est probablement même pas ton principal atout en ce moment."
...
translate french d19s04dd_plushie_e629b25c:
    ...
    dd "Je sais qu'il y a d'autres femmes. Je suis d'accord avec ça.{w} Honnêtement, ça te rend juste plus attirant."
...
translate french d19s04dd_plushie_5b5338b3:
    ...
    dd "Je sais que je ne devrais pas m'attendre à ce que tu laisses tomber tout le monde et tout pour m'accompagner."
...
translate french d19s04dd_plushie_4eeb52a6:
    ...
    dd "Je sais que ce serait vraiment égoïste de ma part de te demander ça."
...
translate french d19s04dd_plushie_51967b0c:
    ...
    dd "Peut-être, vu les circonstances... je veux dire, je n'ai pas beaucoup de temps."
...
translate french d19s04dd_plushie_964a6a69:
    ...
    mc "Je veux dire, je connais ton problème de santé depuis un petit moment maintenant, mais tu es tellement plein de vie que ça ne m'a pas vraiment frappé."
...
translate french d19s04dd_plushie_0cd36633:
    ...
    mc "Je ne veux pas précipiter les choses et faire une erreur."
...
translate french d19s04dd_plushie_0689a0fa:
    ...
    mc "Je veux dire, tu es tellement plein de vie. Tu pourrais avoir des années."

# game/code/d19/d19s04dd.rpy:695
translate french d19s04dd_plushie_f043f2ac:

    # dd "True. Or it could be days or weeks."
    dd "C'est vrai. Ou ça pourrait etre des jours ou des semaines."
...
translate french d19s04dd_plushie_75d5a80a:
    ...
    dd "Si tu veux dire \"non\" je peux vivre avec ça."
...
translate french d19s04dd_plushie_3bd7aa13:
    ...
    dd "Je sais, je demande les meilleurs jours de ta vie.{w} Que tu les passes avec moi."
...
translate french d19s04dd_plushie_bcf5dc0b:
    ...
    mc "Ce n'est pas à propos de ça. C'est une question de responsabilités, de priorités, de choix...{w} Je ne suis pas sûr d'être capable de prendre une décision aussi sérieuse maintenant."

# game/code/d19/d19s04dd.rpy:713
translate french d19s04dd_plushie_588a242d:

    # dw "*cough*Her mother is rich*cough*"
    dw "*Toux* Sa mère est riche *Toux*"
...
translate french d19s04dd_plushie_51c3d4d5:
    ...
    dd "Nous ne sommes pas riches.{w} Classe moyenne supérieure, peut-être, mais ce n'est pas pareil-"
...
translate french d19s04dd_plushie_f6051e7e:
    ...
    dd "Elle est propriétaire d'une petite entreprise."
...
translate french d19s04dd_plushie_bf0e4d79:
    ...
    dw "Je dis juste qu'il n'apprendra rien dans cette université que ta mère ne puisse lui apprendre."

# game/code/d19/d19s04dd.rpy:742
translate french d19s04dd_plushie_9569e376:

    # dd "It's not like that."
    dd "Ce n'est pas comme ça."
...
translate french d19s04dd_plushie_f89eba44:
    ...
    dw "Oui, ça l'est.{w} Il a peur de terminer ses études, d'obtenir son diplôme, de faire sa vie."
...
translate french d19s04dd_plushie_abcff41f:
    ...
    mct "Je suis bien trop jeune pour prendre une décision aussi lourde et qui change ma vie."
...
translate french d19s04dd_plushie_276f416d:
    ...
    mct "D'un autre côté...{w} Eh bien, les cartes sont sur la table et il est temps de suivre, de relancer ou de se coucher."
...
translate french d19s04dd_plushie_198985af:
    ...
    mc "Je veux passer tous les moments possibles avec toi. J'ai juste d'autres choses à finir ici."
...
translate french strings:
    ...
    new "Parie toujours sur le noir"

    # game/code/d19/d19s04dd.rpy:518
    old "Odd is Definitely the Way to Go"
    new "Odd est définitivement la voie à suivre"

    # game/code/d19/d19s04dd.rpy:518
    old "Something like 2nd dozen, maybe"
    new "Quelque chose comme la deuxième douzaine, peut-être"
    ...
    new "Jusqu'à ce que la mort te sépare - Va avec Daisy jusqu'au bout"
