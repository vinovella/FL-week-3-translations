...
translate french e06s07_dd4b315c:
    ...
    sy "C'est probablement le plus beau jour de ta vie. Comment n'es-tu pas nerveux?"

# game/code/e06/e06s07.rpy:38
translate french e06s07_cdff4269:

    # mc "Easy. I delegated all that to you."
    mc "Doucement. Je t'ai délégué tout ça."
...
translate french e06s07_4642bf3d:
    ...
    mc "Ne te méprends pas, Lydia et moi sommes très nerveux depuis des semaines et nous nous efforçons de rendre cette journée parfaite."
...
translate french e06s07_9b00a4cc:
    ...
    sy "C'est vrai, mais je n'avais pas réalisé que Lydia déléguerait tout son stress à Min... qui me stresserait ensuite pour chaque petit détail!"

# game/code/e06/e06s07.rpy:50
translate french e06s07_9dc0b1be:

    # mc "Are you finally done fussing over my appearance yet?"
    mc "Tu as enfin fini de t'inquiéter de mon apparence?"

# game/code/e06/e06s07.rpy:51
translate french e06s07_196a4833:

    # sy "It's as good as it is going to get."
    sy "C'est aussi bon que possible."
...
translate french e06s07_7f35d134:
    ...
    mc "Tu n'as réussi à convaincre personne d'autre de porter ses tenues de mission aujourd'hui, n'est-ce pas?"
...
translate french e06s07_f5bf9e2b:
    ...
    mc "Aucune. Je n'ai jamais été aussi sûr de quoi que ce soit de ma vie."
...
translate french e06s07_78f6d538:
    ...
    mh "... Nous sommes réunis ici pour célébrer l'union légitime et les liens du mariage entre Lydia Cox et [mcname] Young."
...
translate french e06s07_7d730ed8:
    ...
    mh "Le couple a choisi ses propres vœux, qu'ils vont maintenant lire."

# game/code/e06/e06s07.rpy:136
translate french e06s07_b6623c88:

    # lc "Should I go first?"
    lc "Je dois y aller en premier?"
...
translate french e06s07_704c78aa:
    ...
    lc "Tant que nous vivrons tous les deux, tu es le seul homme avec qui j'apprécierai d'être sexuellement, sauf si tu ne m'ordonnes spécifiquement de faire autrement."

# game/code/e06/e06s07.rpy:150
translate french e06s07_aa60a280:

    # lc "As Queen of your Harem, I join a proud sisterhood."
    lc "En tant que reine de ton harem, je rejoins une fière fraternité."

# game/code/e06/e06s07.rpy:151
translate french e06s07_582158bf:

    # lc "I will care for my new sisters as I would care for myself."
    lc "Je prendrai soin de mes nouvelles sœurs comme je prendrais soin de moi-même."
...
translate french e06s07_55a83bed:
    ...
    lc "Je veillerai à ce qu'aucun conflit entre nous ne soit porté à ton attention."
...
translate french e06s07_901a610c:
    ...
    lc "Je veillerai à ce que chacune de nous soit disponible pour apaiser ton esprit et satisfaire ton corps au mieux de nos capacités."
...
translate french e06s07_f5634d16:
    ...
    lc "Si moi ou l'une de mes sœurs échouons, je présenterai mon corps pour ta juste punition."

# game/code/e06/e06s07.rpy:159
translate french e06s07_9d93a936:

    # lc "This I pledge, until death do us part."
    lc "Je le promets, jusqu'à ce que la mort nous sépare."
...
translate french e06s07_ba8ffbc6:
    ...
    mc "Euh, ouais. Ça peut paraître un peu moins impressionnant en comparaison, mais..."
...
translate french e06s07_2338a21d:
    ...
    mc "Lydia, tu es mon rayon de soleil le matin, mon moment préféré de la journée et ma copaine câlin préféré le soir."

# game/code/e06/e06s07.rpy:179
translate french e06s07_ab55d50f:

    # mc "Being with you is the best part of my existence."
    mc "Etre avec toi est et sera la meilleure partie de mon existence."
...
translate french e06s07_c8e29a0f:
    ...
    mc "Je t'aime au-delà de toute mesure et je promets de continuer à le faire même après que le soleil se soit éteint."
...
translate french e06s07_233f0d4a:
    ...
    arj "*Chuchote* Tu voudrais peut-être..."
...
translate french e06s07_5525fcba:
    ...
    mc "Je m'engage à utiliser ma reine et mon harem pour satisfaire mes besoins sexuels."
...
translate french e06s07_9607a85e:
    ...
    mc "Pour veiller à leur contentement et satisfaire leurs besoins sexuels, soit par moi-même, soit en utilisant les membres de mon harem."

# game/code/e06/e06s07.rpy:241
translate french e06s07_542e4451:

    # mc "To assist Lydia in the management of my Harem."
    mc "Pour assister Lydia dans la gestion de mon harem."
...
translate french e06s07_0a69ae3b:
    ...
    mc "Et aimer et prendre soin de chaque membre du harem tant qu'elles me sont utiles."
...
translate french e06s07_18f85531:
    ...
    mh "Je suis d'accord.{w} Pour le moment, je crois que notre reine a des vœux supplémentaires au nom du Harem."
...
translate french e06s07_608d4b1b:
    ...
    mh "Je suis d'accord.{w} Pour le moment, je crois que la reine a des vœux supplémentaires au nom du Harem."
...
translate french e06s07_ac729b7a:
    ...
    lc "Nous suivrons les conseils de notre reine et servirons [mcname] au mieux de nos capacités."
...
translate french e06s07_0e7232d2:
    ...
    mh "Y a-t-il autre chose que vous aimeriez dire avant de continuer?"
...
translate french e06s07_c2df1d86:
    ...
    mc "Lydia, avec cette bague, devient ma femme."

# game/code/e06/e06s07.rpy:310
translate french e06s07_938ca1bc:

    # lc "Oh, [mcname]. I'm so happy I could burst."
    lc "Oh, [mcname]. Je suis tellement heureuse que je pourrais éclater."
...
translate french e06s07_9ce60b9c:
    ...
    lc "[mcname], mon Roi, mon Amour, mon Maître en toutes choses. Avec cette bague, devient mon mari."

# game/code/e06/e06s07.rpy:318
translate french e06s07_86682f82:

    # mh "Oops. I forgot one little detail."
    mh "Oups. J'ai oublié un petit détail."
...
translate french e06s07_1bb05fdd:
    ...
    mh "S'il y a quelqu'un présent ici, qui pour une raison ou une autre s'oppose a leur union, qu'il parle maintenant ou taise à jamais."
...
translate french e06s07_bcb277a4:
    ...
    mh "Alors, grâce au pouvoir dont l'État m'a investi, je vous déclare maintenant mari, femme et harem."

# game/code/e06/e06s07.rpy:329
translate french e06s07_55c2b00c:

    # mh "You may kiss the bride!"
    mh "Tu peux embrasser la mariée!"
