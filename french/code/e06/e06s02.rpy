...
translate french e06s02_e2d63846:
    ...
    lc "Je ne partirai pas. Je sais que tu es là, parce que nous sommes toujours amies sur FriendFinder, Min."
...
translate french e06s02_f526fd43:
    ...
    lc "Je n'arrive même pas à faire comprendre à ma meilleure amie que je sais que j'ai fait une énorme erreur."
...
translate french e06s02_aa451f48:
    ...
    mc "J'avais oublié qu'en plus d'avoir une voix merveilleuse, tu as le don de prévoyance."
...
translate french e06s02_85411c4f:
    ...
    mes "Non. Quand les gens mettent des oignons sur ton hamburger alors que tu demandes pas d'oignons."
...
translate french e06s02_a7db7448:
    ...
    mes "Ce que tu as fait était illégal et trompeur."
...
translate french e06s02_eab9aaab:
    ...
    mes "Tu es une menteuse, Lydia ! Tu étais censée être ma meilleure amie."

# game/code/e06/e06s02.rpy:191
translate french e06s02_c2698a9b:

    # mes "But you lied right to my face. Like a criminal."
    mes "Mais tu m'as menti en face. Comme une criminelle."
...
translate french e06s02_cfa3eceb:
    ...
    mc "Lydia n'est pas une criminelle. Le juge l'a déclarée 'non coupable', Min."
...
translate french e06s02_898f3335:
    ...
    lc "Co-co-comment fait-il si froid? C'est le milieu de l'été-é-é."
...
translate french e06s02_inside_865c3c36:
    ...
    mc "Je t'ai demandé si tu allais bien."
...
translate french e06s02_inside_1dc4fa3a:
    ...
    lc "Je pense que tout ira bien. C'est juste... tu as vu comment elle me regardait?"
...
translate french e06s02_inside_e40acce8:
    ...
    mc "Oui. Mais j'ai aussi vu comment elle t'a invité pour t'aider à te sécher."
...
translate french e06s02_inside_b4454227:
    ...
    mes "Ils sont dans la chambre d'amis au bout du couloir."
...
translate french e06s02_inside_0c764b95:
    ...
    mes "Même après tout... tout ce que tu as vécu avec l'application, et savoir que Lydia était impliquée..."

# game/code/e06/e06s02.rpy:323
translate french e06s02_inside_80be8b53:

    # mes "You've truly forgiven her?"
    mes "Tu lui as vraiment pardonné?"
...
translate french e06s02_inside_18de6647:
    ...
    mes "*Soupir* Deux personnes ne peuvent pas rester amies longtemps si elles ne peuvent pas se pardonner les petits défauts de l'autre."

# game/code/e06/e06s02.rpy:332
translate french e06s02_inside_900df7fa:

    # mc "Jean de La Bruyère would be proud."
    mc "Jean de La Bruyère serait fier."
...
translate french e06s02_inside_6656d334:
    ...
    mes "Oui. Mais les autres ne seront pas aussi fiers. Pas si je pardonne à Lydia."
...
translate french e06s02_inside_cd98dd5d:
    ...
    mc "Ce que tu fais ici ne dépend pas de ta famille, Min. C'est ta décision."
...
translate french e06s02_inside_86dcc93d:
    ...
    mes "Pourquoi a-t-elle fait cette tournée de rédemption avec moi?"

# game/code/e06/e06s02.rpy:347
translate french e06s02_inside_95eef4a4:

    # mc "You two were so close. It's hitting Lydia hard."
    mc "Vous étiez si proches toutes les deux. Ça frappe durement Lydia."
...
translate french e06s02_inside_ac67bcd1:
    ...
    mes "Ma famille m'appelle depuis qu'on a appris qu'elle était en prison."

# game/code/e06/e06s02.rpy:351
translate french e06s02_inside_59e30423:

    # mes "They want me to go back to Korea and never leave."
    mes "Ils veulent que je retourne en Corée et que je ne revienne jamais."
...
translate french e06s02_inside_8fcefd64:
    ...
    mc "Mais tu ne vas pas faire ça, n'est-ce pas?"
...
translate french e06s02_inside_48001862:
    ...
    lc "S'il te plaît, ne pars pas, Min."
...
translate french e06s02_inside_83bf5d23:
    ...
    mes "Je suis vraiment désolée. Tu as juste l'air ridicule, Lydia."
...
translate french e06s02_inside_35f735f5:
    ...
    mes "J'ai besoin que vous écoutiez attentivement. Tout les deux."
...
translate french e06s02_inside_af9528f7:
    ...
    mes "Maintenant... je ne sais pas si nous avons la possibilité de revenir à la façon dont les choses étaient avant..."
...
translate french e06s02_inside_06c00b8b:
    ...
    mes "Et je n'avais pas prévu de te revoir avant un long moment. Sans doute même pour toujours."
...
translate french e06s02_inside_a755748b:
    ...
    mes "Elle n'aurait certainement pas pu apprendre tout ce qui est unique... les plaisirs des sports nautiques ."
...
translate french e06s02_inside_5ae2ee77:
    ...
    mes "Peu de choses peuvent égaler ce niveau de liberté et d'intimité. Certainement jamais rien que Squizzle ait vécu."
...
translate french e06s02_inside_ad21e7ac:
    ...
    mes "Je doute qu'elle ressente un jour une véritable affection non plus... mais grâce à [mcname], je pense que je me suis rapproché."
...
translate french e06s02_inside_12076c0c:
    ...
    mes "Pour ce bonheur, il est logique qu'il y ait une certaine tristesse pour équilibrer les choses."

# game/code/e06/e06s02.rpy:405
translate french e06s02_inside_b016c83e:

    # mes "Say what you're here to say, Lydia."
    mes "Dis ce pour quoi tu es venue, Lydia."
...
translate french e06s02_inside_2ccbd619:
    ...
    lc "Je veux te dire à quel point je suis désolée, Min.  Je n'ai jamais voulu te faire de mal. Et je ne veux pas que tu partes."
...
translate french e06s02_inside_b01c2ee6:
    ...
    lc "Je sais que ça ne comptera pas beaucoup, mais une fois que j'ai réalisé à quel point les choses étaient allées, je me suis rendue et j'ai expliqué ce qui se passait."
...
translate french e06s02_inside_ba401dd3:
    ...
    lc "J'aurais dû me douter que Fetish Locator s'avérerait méchant. Ce n'est pas comme si son origine était complètement pure."
...
translate french e06s02_inside_c2660f6d:
    ...
    lc "Je voulais expérimenter des choses. Et je... je me suis mentie. J'ai commencé à être convaincue que l'utilisation de Fetish Locator me permettrait enfin de rivaliser avec toi."
...
translate french e06s02_inside_77edfd14:
    ...
    mes "Lydia... tout entre nous ne doit pas nécessairement être une compétition."
...
translate french e06s02_inside_204a9a46:
    ...
    lc "Je sais mais. Ce n'est pas comme un interrupteur. Entre nous, tu as pris toutes les premières..."
...
translate french e06s02_inside_a9ed4e36:
    ...
    lc "Sans quelque chose comme Fetish Locator, comment pourrais-je un jour être à la hauteur."
...
translate french e06s02_inside_38bf30c7:
    ...
    mes "*Rires* Je l'admets, une partie de moi s'ennuyait un peu en étant toujours la premiere."
...
translate french e06s02_inside_55fc2538:
    ...
    mes "Mais je ne comprends pas une chose. Tu es venu chez moi tellement de fois."

# game/code/e06/e06s02.rpy:472
translate french e06s02_inside_7acf4641:

    # mes "How did you forget about the stairs?"
    mes "Comment as-tu oublié les escaliers?"
...
translate french e06s02_inside_1ccb6013:
    ...
    lc "Eh bien... je pensais que quoi qu'il arrive, tu ne pourrais pas résister à l'envie de m'aider après que je me sois ridiculisé."

# game/code/e06/e06s02.rpy:477
translate french e06s02_inside_9f413db3:

    # mes "Haha. I should have let you freeze a little more."
    mes "Haha. J'aurais dû te laisser geler un peu plus."
...
translate french e06s02_inside_14982f2a:
    ...
    mes "Ça fait plus d'un mois que je ne t'ai pas vu. Et si tu ne me donnes pas de bites maintenant, je vous vire tous les deux de chez moi."
...
translate french e06s02_inside_ef31455a:
    ...
    lc "J'avais peur... quand j'étais en cellule...de ne plus jamais avoir l'occasion de revoir quelque chose comme ça."
...
translate french e06s02_inside_3a9a551c:
    ...
    mes "Mmhmm.  Tu vas continuer à voir ça...  et bien plus encore."
...
translate french e06s02_bj_7e7f582f:
    ...
    mct "Je ne me lasserai jamais de regarder ma copine baver pendant que je baise d'autres filles."
...
translate french e06s02_bj_95ec38ce:
    ...
    lc "Ça l'était, mais aussi profond que soit notre amour, je suis toujours très reconnaissante de ne pas t'avoir perdu, Min."

# game/code/e06/e06s02.rpy:765
translate french e06s02_bj_2ce90328:

    # mes "I know, Lydia. I love both of you so much..."
    mes "Je sais, Lydia. Je vous aime tellement tous les deux..."
...
translate french e06s02_sex_c9b902a3:
    ...
    mes "S'il te plaît... continue de pousser ta langue en moi."
...
translate french e06s02_sex_632589fb:
    ...
    mes "Mhmm... quel goût a-t-il, Lydia.?"
...
translate french e06s02_sex_efcb925e:
    ...
    mc "Et Min, même quand tu oublies de mendier, je t'aimerai toujours."

# game/code/e06/e06s02.rpy:918
translate french e06s02_sex_9d9492e6:

    # mes "*Happy stifled moans*"
    mes "*Joyeux gémissements étouffés*"
...
translate french e06s02_sex_194b53bf:
    ...
    lc "Pas encore. Tu ne devrais plus jouir avant que [mcname] le fasse."
...
translate french e06s02_sex_573585a0:
    ...
    mes "D'accord... je vais essayer. Il est si intense quand il m'empale."

# game/code/e06/e06s02.rpy:981
translate french e06s02_sex_5c5f66e3:

    # lc "I'll be with you. The whole way."
    lc "Je serai avec toi. Tout du long."
...
translate french e06s02_sex_9b9c29e2:
    ...
    mes "S'il te plaît... laisse-moi jouir, Lydia. J'ai l'impression que mon cerveau fond."

# game/code/e06/e06s02.rpy:1051
translate french e06s02_sex_a57d201d:

    # lc "Okay... This time, I'll let you cum."
    lc "D'accord... cette fois, je te laisse jouir."
...
translate french e06s02_sex_681b46c9:
    ...
    lc "Mais je pense que nous allons devoir travailler sur ton endurance."

# game/code/e06/e06s02.rpy:1057
translate french e06s02_sex_2d78a730:

    # lc "Or [mcname] will always beat us."
    lc "Ou [mcname] nous battra toujours."
...
translate french e06s02_sex_96dcddf2:
    ...
    lc "Alors jouis. Laisse-le sentir ton jus éclabousser sa bite."
...
translate french e06s02_sex_dcd7932a:
    ...
    mes "Je ne pense pas que je pourrai marcher pendant quelques jours."
...
translate french e06s02_sex_4d1ce34d:
    ...
    mes "Lydia. Puisque tu veux vraiment faire amende honorable, est ce que tu vas t'arrêter uniquement à mon pardon?"

# game/code/e06/e06s02.rpy:1132
translate french e06s02_sex_ab066432:

    # mes "Fetish Locator cast a wide net."
    mes "Fetish Locator a ratissé large..."
...
translate french e06s02_sex_d8c51d34:
    ...
    lc "C'est vrai. Mais... faire en sorte que les autres me pardonnent va être très difficile."

# game/code/e06/e06s02.rpy:1138
translate french e06s02_sex_2ed4c0f4:

    # mes "Of course it will be."
    mes "Bien sûr que ce sera le cas."
...
translate french e06s02_sex_cfdfa501:
    ...
    mes "En plus, je suis sûr que tu peux demander à [mcname] de t'aider à arrondir les angles."
...
translate french e06s02_sex_bd6c66f2:
    ...
    lc "Pourquoi tu ne viens pas avec nous, Min?"
...
translate french e06s02_sex_caca1607:
    ...
    lc "Oui! En ce moment, la maison est beaucoup trop vide. Même avec [mcname] dans les parages."
...
translate french e06s02_sex_fe320a36:
    ...
    mc "Et tu n'auras jamais à rester aussi longtemps sans goûter à ta friandise préférée."

# game/code/e06/e06s02.rpy:1170
translate french e06s02_sex_e405fecc:

    # mes "Alright, you make a very convincing argument."
    mes "Très bien, tu avances un argument très convaincant."
...
translate french e06s02_sex_e8d5948f:
    ...
    mes "En plus... quelqu'un doit te garder à l'écart des ennuis."
...
translate french e06s02_sex_b1cd4d51:
    ...
    lc "Que ferais-je sans vous deux?"
