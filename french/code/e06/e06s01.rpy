...
translate french e06s01_e3fb20b7:
    ...
    lc "J'ai vu le regard dans les yeux de cette juge à chaque fois qu'elle me regardait."
...
translate french e06s01_7eaac46d:
    ...
    mc "Ça n'arriverait jamais. Je t'aime et je serai toujours à tes côtés, Lydia."

# game/code/e06/e06s01.rpy:164
translate french e06s01_c0030af2:

    # lc "You have no idea how happy that makes me."
    lc "Tu n'imagines pas à quel point ça me rend heureuse."
...
translate french e06s01_c9920062:
    ...
    lc "Quand tu me tiens comme ça, je me sens en sécurité... comme si je pouvais à nouveau respirer."
...
translate french e06s01_d4465dcc:
    ...
    lc "Je n'arrête pas de rejouer des choses dans ma tête."
...
translate french e06s01_812193e1:
    ...
    lc "Il n'y a pas de Fetish Locator sans que je révèle mon secret à Jérôme."
...
translate french e06s01_200dcac1:
    ...
    mc "Tu ne peux pas penser comme ça. Tu ne contrôlais pas l'application. Et une fois sorti, tu ne contrôle plus sa propagation."
...
translate french e06s01_cdfb4896:
    ...
    mc "C'est comme essayer d'attraper une boule de neige après qu'elle ait dévalé une pente pendant dix minutes."
...
translate french e06s01_efcaf011:
    ...
    mc "Voyons voir. Messages d'AmRose et Stacy. Et pas trop surprenant, une diatribe vraiment en colère de Hana..."

# game/code/e06/e06s01.rpy:212
translate french e06s01_4b1825ec:

    # mc "Who needs them, Lydia?"
    mc "Qui a besoin d'eux, Lydia?"

# game/code/e06/e06s01.rpy:215
translate french e06s01_6be2eaf4:

    # lc "I need... I'm going to need your help with something, [mcname]..."
    lc "J'ai besoin... je vais avoir besoin de ton aide pour quelque chose, [mcname]..."
...
translate french e06s01_9e7c3fbe:
    ...
    mc "Mais le problème, c'est que c'est toi qui as mis mon éléphant en cage."

# game/code/e06/e06s01.rpy:235
translate french e06s01_9be5f820:

    # lc "That wasn't me, that was Ridley. You know, the A.I."
    lc "Ce n'était pas moi, c'était Ridley. Tu sais, l'IA."
...
translate french e06s01_17ec13ae:
    ...
    mc "Je le sais et tu le sais. Mais pense à tous les gens qui ne se soucient pas de la différence."
...
translate french e06s01_6ddd330f:
    ...
    mc "En plus... je pense que tu as aimé avoir ma bite enfermée à ta manière. Tu peux l'admettre."
...
translate french e06s01_944d121e:
    ...
    lc "Oui... j'ai aimé ça. Ca m'assurais que quoi qu'il arrive, je ne pourrais pas céder."
...
translate french e06s01_22a1523a:
    ...
    lc "J'étais en sécurité à ce moment-là. Maintenant... maintenant c'est hors de contrôle. J'aurais aimé ne jamais rencontrer Jérôme!"
...
translate french e06s01_853f7d9e:
    ...
    mc "Nous cherchions tous les deux quelque chose de spécial. Et nous l'avons trouvé, grâce à toi."
...
translate french e06s01_cc7a532e:
    ...
    mc "Le voyage a été semé d'embûches, mais c'était un voyage que je recommencerais, juste pour arriver ici."

# game/code/e06/e06s01.rpy:251
translate french e06s01_efa636e5:

    # lc "You're the best, [mcname]."
    lc "Tu es le meilleur, [mcname]."
...
translate french e06s01_4486313b:
    ...
    lc "En parlant de bosses, je... souviens-toi de ce que je voulais te demander, [mcname]."
...
translate french e06s01_b873b9d9:
    ...
    lc "C'est Min. Je peux supporter que tout le monde me traite de menteuse et... pire..."

# game/code/e06/e06s01.rpy:263
translate french e06s01_72f4137a:

    # lc "But not her. Not my best friend."
    lc "Mais pas elle. Pas ma meilleure amie."
...
translate french e06s01_299f6032:
    ...
    mc "Eh bien... tu devras peut-être accepter que le pardon prendra du temps."

# game/code/e06/e06s01.rpy:269
translate french e06s01_2daa9175:

    # lc "I do. I swear I do."
    lc "Je le ferais. Je le jure."
...
translate french e06s01_3c92b8d1:
    ...
    lc "Mais... j'ai pensé, si tu venais avec moi pour la rencontrer. Peut-être qu'elle m'écoutera."
...
translate french e06s01_d883f10f:
    ...
    mc "Haha. Tu ne veux pas l'enfermer dans une cage pour qu'elle t'écoute?"
...
translate french e06s01_f7cce481:
    ...
    lc "Le pardon total signifie me pardonner de t'avoir gardé dans cette cellule pendant que je parlais."
...
translate french e06s01_fa0bce90:
    ...
    mc "Bien sûr. Ne sois pas surprise si je suis plus un animal qu'un homme, quand nous ferons enfin l'amour."
...
translate french e06s01_22085584:
    ...
    lc "Je ne t'en tiendrai jamais rigueur. En fait... je suis un peu excitée juste de voir de quoi tu es capable..."

# game/code/e06/e06s01.rpy:284
translate french e06s01_d45dc55a:

    # lc "When you're... unrestrained..."
    lc "Quand tu es... sans retenue..."
...
translate french strings:
    ...
    new "Choisis des personnages facultatifs pour cette fin"
