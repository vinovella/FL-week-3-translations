...
translate french d20s08_b3e81c75:
    ...
    arj "Eh bien, ça répond à cette question."
...
translate french d20s08_87dff618:
    ...
    arj "Que tu sois ou non celui qui a cassé la scéllé de la police."
...
translate french d20s08_e32434d9:
    ...
    arj "Elle essaie de déterminer si quelqu'un est encore à l'intérieur."
...
translate french d20s08_19503875:
    ...
    sy "Nous ne voulons pas être surpris ou pris en embuscade là-dedans ou tomber accidentellement sur les flics."
...
translate french d20s08_62a634d0:
    ...
    sy "Eh bien, si tu peux sortir ta vision de Superman et voir à travers les murs, vas-y."
...
translate french d20s08_9ca60387:
    ...
    mc "Stacy, nous t'aimons tous les deux, alors quand je dis ça, je le pense du plus profond de mon cœur..."
...
translate french d20s08_7e7637dc:
    ...
    sy "Désolée, c'est vraiment fastidieux et probablement inutile et j'ai des crampes aux mains et je suis un peu frustré."
...
translate french d20s08_48b1a42f:
    ...
    mct "Je ne suis pas sûr d'aimer cette idée."
...
translate french d20s08_bb9da382:
    ...
    arj "Eh bien, je veux dire, [mcname] a reçu le code de Hana. Ce n'est pas comme si nous devions forcer la porte."
...
translate french d20s08_6311216f:
    ...
    sy "Je suis désolée, mais j'ai besoin d'une pause. Je vais chercher de la glace pour mes mains et du café pour mon sang."
...
translate french d20s08_a902f8b6:
    ...
    mct "AmRose prépare quelque chose, mais je ne sais pas quoi."

# game/code/d20/d20s08.rpy:106
translate french d20s08_44234562:

    # mc "Yeah, no. I mean, I'm good."
    mc "Ouais, non. Je veux dire, c'est bon."
...
translate french d20s08_mc_arj_f02f211d:
    ...
    mc "Je suis content. Cependant, je suppose que tu ne voulais pas qu'elle parte juste pour que nous puissions avoir une séance de maquillage ici."
...
translate french d20s08_mc_arj_256a3bf1:
    ...
    mct "S'il te plaît, dis \"pipe\". S'il te plaît, dis \"pipe\"."
...
translate french d20s08_mc_arj_7c0dbed2:
    ...
    mc "Je n'en ai littéralement aucune idée."
...
translate french d20s08_mc_arj_deebf87d:
    ...
    mc "Je pense que tu voulais dire \"Voila\"."
...
translate french d20s08_mc_arj_44edcad4:
    ...
    arj "Soit, les deux, peu importe. Tape juste le code et c'est parti."
...
translate french d20s08_mc_arj_99ebb93d:
    ...
    arj "Qui a dit que ce n'était pas sûr? En plus, si Stacy revient avant qu'on entre, elle voudra tout copier avant qu'on le supprime."

# game/code/d20/d20s08.rpy:161
translate french d20s08_mc_arj_811bf22a:

    # mc "And you want to just delete it."
    mc "Et tu veux juste le supprimer."
...
translate french d20s08_mc_arj_3106a8a9:
    ...
    arj "Je veux détruire tout enregistrement de ces photos et vidéos existant."
...
translate french d20s08_mc_arj_518a1ac8:
    ...
    arj "Non. Elle a peur que je supprime tout avant de pouvoir le copier."
...
translate french d20s08_mc_arj_065a46b1:
    ...
    arj "Mes photos de chantage, idiot."
...
translate french d20s08_mc_arj_f66a4dac:
    ...
    mc "Bien sûr, nous allons les supprimer. Stacy ne peut pas prévoir de faire quoi que ce soit avec le chantage."

# game/code/d20/d20s08.rpy:185
translate french d20s08_mc_arj_c1a36d34:

    # arj "My photos, dumbass."
    arj "Mes photos, idiot."
...
translate french d20s08_mc_arj_535f298b:
    ...
    mc "Bien sûr, nous allons les supprimer. Stacy ne ferait rien-"
...
translate french d20s08_mc_arj_f32ac7d7:
    ...
    mc "Je sais que tu n'es pas spécialisé en commerce, mais tu as suivi suffisamment de cours de commerce pour savoir négocier."
...
translate french d20s08_mc_arj_46748081:
    ...
    arj "Je serai ta meilleure amie."
...
translate french d20s08_mc_arj_33a050c8:
    ...
    mc "Si tu me tues avant le retour de Stacy, tu n'ouvriras jamais cette porte."
...
translate french d20s08_mc_arj_4708eb9c:
    ...
    mc "Si tu m'assassines après le retour de Stacy, ça ne servirait à rien."
...
translate french d20s08_mc_arj_13e1ca09:
    ...
    mc "Je ne sais pas. J'espère que tu continueras à proposer des idées avant que Stacy ne revienne."
...
translate french d20s08_mc_arj_95dd623e:
    ...
    arj "Tu n'as pas besoin de supprimer d'autres fichiers jusqu'au retour de Stacy."
...
translate french d20s08_mc_arj_f9d0537b:
    ...
    arj "Non. Je viens avec toi et je te suce la bite pendant que tu le fais."
...
translate french d20s08_mc_arj_49870eab:
    ...
    mc "Non. C'est ce que tu as dit à Stacy, \"Ça ressemble à un plan\"."
...
translate french d20s08_mc_arj_df46cf5e:
    ...
    mc "Je ne m'inquiète pas pour les fichiers. J'ai peur d'agir dans le dos de Stacy."

# game/code/d20/d20s08.rpy:247
translate french d20s08_mc_arj_5660623a:

    # arj "Look, I'll do anything you want. ANYTHING you want."
    arj "Ecoute, je ferai tout ce que tu veux. TOUT ce que tu veux."
...
translate french d20s08_mc_arj_8be3fd77:
    ...
    arj "Tu peux me chier au visage et me dire de l'avaler. Je m'en fiche."
...
translate french d20s08_mc_arj_6ebe037a:
    ...
    mc "Pas les excréments. Sois mon génie. Accorde-moi 3 vœux, tout ce que je veux."
...
translate french d20s08_mc_arj_6f2723db:
    ...
    mc "En plus des termes précédents. Je suis le seul à accéder au serveur jusqu'à ce que Stacy revienne, et tu me suces la bite pendant que je supprime les fichiers."
...
translate french d20s08_jumped_f1b34c0b:
    ...
    mc "Jérôme.{w} Espèce de connard.{w} J'aurais dû le savoir-"
...
translate french d20s08_jumped_937ff1cd:
    ...
    js "Je faisais semblant lors de notre précédent combat."
...
translate french d20s08_jumped_131f64ce:
    ...
    js "Quand je t'ai combattu pour Lydia... c'était juste pour faire semblant."

# game/code/d20/d20s08.rpy:385
translate french d20s08_jumped_50ea7555:

    # js "I was distracted during our previous fight."
    js "J'ai été distrait lors de notre précédent combat."
...
translate french d20s08_jumped_f9c0f835:
    ...
    mc "Je vais te faire tellement de mal pour ça."
...
translate french d20s08_server_15aa7ead:
    ...
    mc "C'est une bonne chose que tu aies toujours une longueur de corde avec toi."

# game/code/d20/d20s08.rpy:445
translate french d20s08_server_113d8eb2:

    # arj "A woman's gotta be prepared for her man."
    arj "Une femme doit être préparée pour son homme."
...
translate french d20s08_server_be39b315:
    ...
    mc "Je suis presque sûr que l'une de vous devrait me sucer la bite pendant que je suis assis ici."
...
translate french d20s08_server_d1e19447:
    ...
    arj "Le marché était qu'on faisait ça avant le retour de Stacy."
...
translate french d20s08_server_8a552a87:
    ...
    arj "Rien. Ne t'inquiète pas pour ça."
...
translate french d20s08_server_7625bbb7:
    ...
    mc "En fait, oui. Je dois supprimer les fichiers de chantage avant que tu fasses quoi que ce soit."
...
translate french d20s08_server_c7adb7ba:
    ...
    mc "En fait, oui. Je dois supprimer tous les fichiers d'AmRose avant que tu fasses quoi que ce soit."
...
translate french d20s08_server_398469b7:
    ...
    arj "Comment vas-tu savoir lequel-?"
...
translate french d20s08_server_80782097:
    ...
    sy "Non, je ne t'ai pas vu te branler à côté de Lydia pendant qu'elle dormait."
...
translate french d20s08_server_d0f8b51e:
    ...
    sy "Je pourrais jeter un œil à ce que mon frère a fait."

# game/code/d20/d20s08.rpy:548
translate french d20s08_server_3b569c8e:

    # sy "I might sneak a peek at what [mcname] has been doing."
    sy "Je pourrais peut-être jeter un coup d'œil à ce que [mcname] a fait."
...
translate french d20s08_server_6ab1f4b5:
    ...
    sy "On pourra en discuter plus tard."
...
translate french d20s08_server_7c352e2c:
    ...
    sy "Donc, nous avons un désaccord. Je suis prête à laisser ça être résolu démocratiquement."
...
translate french d20s08_server_e5d22710:
    ...
    arj "Tu connais mon opinion. Détruis tout. Pas de copies."
...
translate french d20s08_server_9396a57f:
    ...
    mc "Et je veux dire tout. Je ne veux pas découvrir qu'il y a des copies malveillantes sur un serveur cloud ou quelque chose comme ça."

# game/code/d20/d20s08.rpy:586
translate french d20s08_server_febb080f:

    # sy "Understood. I'll nuke everything."
    sy "J'ai compris. Je vais tout détruire."
...
translate french d20s08_server_b2e2c0dd:
    ...
    mc "Très bien, je suppose que nous devrions attendre que tu aies fini avant d'appeler la police."
...
translate french d20s08_server_f852bda8:
    ...
    sy "Rien qui n'implique aucun de vous... juste quelque chose qui a l'air sexy."
...
translate french d20s08_server_7dd11821:
    ...
    sy "C'est étiqueté \"IR masturbating\" et j'ai regardé les premières secondes..."
...
translate french d20s08_server_95d7c88e:
    ...
    sy "On dirait une putain de vidéo torride d'elle en train de passer un peu de temps seule."
...
translate french d20s08_server_4596aa34:
    ...
    arj "Ok, j'avoue qu'elle est plutôt sexy."
...
translate french d20s08_ir_video_c0ea9e0a:
    ...
    arj "Je suis d'accord avec [mcname]. Arrête la vidéo."
...
translate french d20s08_end_5616b712:
    ...
    mc "Très bien, Stacy. Détruis tout."
...
translate french d20s08_end_fd2f1a36:
    ...
    sy "J'ai écrit un programme spécial juste pour cette tâche."
...
translate french d20s08_end_269f47b0:
    ...
    sy "Il effacera tout ce qui concerne Fetish Locator, de sorte que même la NSA ne pourra pas le récupérer."
...
translate french d20s08_end_18a1a642:
    ...
    sy "D'accord...{w} J'appuie sur Retour."
...
translate french d20s08_end_7ba72145:
    ...
    arj "Très bien. Pendant que tu fais ça, je vais préparer un rapport anonyme indiquant qu'il y a eu une effraction dans cette salle de serveurs."
...
translate french d20s08_end_0a0ddac3:
    ...
    sy "Tu sais, attacher les méchants et les laisser à la police sans aucune explication."
...
translate french d20s08_end_243296be:
    ...
    arj "Bien vu. Je vais ajouter une liste de leurs crimes possibles au rapport anonyme."
...
translate french d20s08_end_1e5254f8:
    ...
    mct "Je n'arrive pas à croire qu'on y réfléchisse plus que..."
...
translate french strings:
    ...
    new "Aux côtés de Stacy - Copier puis Supprimer"

    # game/code/d20/d20s08.rpy:570
    old "Side with AmRose - Destroy it Completely"
    new "Aux côtés d'AmRose - Détruis-le complètement"

    # game/code/d20/d20s08.rpy:615
    old "Alright, I want to see the video"
    new "Très bien, je veux voir la vidéo"
