...
translate french d20s02rn_29067eed:
    ...
    mc "Oui et oui. Il est là et j'ai une assez bonne vue. Je devrais pouvoir voir quand il te pénètre."
...
translate french d20s02rn_6df74e25:
    ...
    mc "J'ai supposé que c'était juste parce que tu es une garce perverse et que ça t'a fait jouir."
...
translate french d20s02rn_d60f6cee:
    ...
    mk "Oui aussi.{w} Nordin a des goûts particuliers, d'après ce que j'ai entendu."
...
translate french d20s02rn_76512c0a:
    ...
    mk "Il pourrait m'étouffer. On pourrait croire qu'il me fait du mal.{w} Il pourrait même me faire du mal."

# game/code/d20/d20s02rn.rpy:63
translate french d20s02rn_899cbddf:

    # mc "Fuck, Maria, I didn't know."
    mc "Putain, Maria, je ne savais pas."
...
translate french d20s02rn_952720a7:
    ...
    mk "Non.{w} Nous n'avons qu'une seule chance, alors n'interrompe rien tant que tu n'es pas certain de l'avoir pris en flagrant délit."
...
translate french d20s02rn_2be5cc1f:
    ...
    mk "Non.{w} Nous n'aurons qu'une seule chance, alors ne l'interrompe pas tant que tu n'es pas certain qu'il est suffisamment satisfait."
...
translate french d20s02rn_da72b1e8:
    ...
    mc "Si tu le dis.{w} Si tu veux te retirer de ça, pas de probleme, pas de faute. Je t'en tiendrai pas rigueur."
...
translate french d20s02rn_12972130:
    ...
    mk "Ne t'inquiète pas, [mcname]. J'ai fait bien pires pour de pires raisons."

# game/code/d20/d20s02rn.rpy:88
translate french d20s02rn_5784121f:

    # mct "What?{w} I'm so confused."
    mct "Quoi?{w} Je suis tellement confus."
...
translate french d20s02rn_425d2016:
    ...
    mk "Je voulais vous voir, monsieur."
...
translate french d20s02rn_a8efdf33:
    ...
    rn "Oui, Miss Kovalevich. Il fait plutôt chaud. Je préfère ça.{w} Vous comprendrez quand vous serez plus agé."

# game/code/d20/d20s02rn.rpy:122
translate french d20s02rn_81ceb85d:

    # mk "Oh good, I thought it was just me.{w} Hot, that is."
    mk "Oh bien, je pensais que c'était juste moi.{w} Chaud, c'est vrai."
...
translate french d20s02rn_0e728114:
    ...
    mk "Eh bien, j'ai entendu dire que vous êtes toujours disponible à ces heures-là pour tes étudiantes."
...
translate french d20s02rn_cf229ae4:
    ...
    rn "Je manque rapidement de disponibilité et vous ne semblez pas sur le point de me dire de quoi il s'agit."

# game/code/d20/d20s02rn.rpy:140
translate french d20s02rn_7154853d:

    # mk "It's about my pencil..."
    mk "C'est à propos de mon crayon..."
...
translate french d20s02rn_37a4fc0c:
    ...
    rn "Ça n'a pas affecté vos notes. Ce que vous et Monsieur Young faites en privé ne me regarde pas."
...
translate french d20s02rn_550ebea7:
    ...
    rn "Miss Kovalevich, vous avez déjà réussi vos examens pour ce semestre, avec brio, pourrais-je ajouter."
...
translate french d20s02rn_1aac1d9c:
    ...
    mk "Exactement, Ronald.{w} Nous ne sommes plus professeur et étudiant. Du moins pas pour cet été."

# game/code/d20/d20s02rn.rpy:159
translate french d20s02rn_17ed4952:

    # mk "It could be a long, hard summer for both of us."
    mk "Ça pourrait être un été long et dur pour nous deux."
...
translate french d20s02rn_b1c28883:
    ...
    rn "Miss Kovalevich.{w} *Ahem*, Maria. Je ne suis pas sûr de ce que vous avez entendu."
...
translate french d20s02rn_e517272e:
    ...
    mk "J'ai lu les rapports du tribunal. Son témoignage est du domaine public."
...
translate french d20s02rn_797bd5a6:
    ...
    mk "J'ai retrouvé ta dernière petite amie.{w} Elle m'a dit exactement à quoi m'attendre."
...
translate french d20s02rn_bad5733c:
    ...
    mk "Je m'excuse de ne pas t'avoir laissé arracher mes vêtements.{w} J'espère que ça pourra attendre plus tard."
...
translate french d20s02rn_3e5c974a:
    ...
    mk "Je n'en rêverais pas. Considère ça comme un geste de bonne foi ou comme un paiement pour mes services."
...
translate french d20s02rn_e02bb381:
    ...
    mk "Tu nous as appris à ne jamais écouter les potins ou les rumeurs. J'ai besoin d'une preuve."

# game/code/d20/d20s02rn.rpy:249
translate french d20s02rn_2995cdb8:

    # mk "Right here. Right now."
    mk "Juste ici. Maintenant."
...
translate french d20s02rn_42fa303a:
    ...
    mk "Je veux que tu me violes jusqu'au bout, ici même sur ton bureau."
...
translate french d20s02rn_d659ce55:
    ...
    mk "Je veux que tu me baises sans raison ici, sur ton bureau."
...
translate french d20s02rn_426e0919:
    ...
    rn "Ne t'inquiète pas, connasse.{w} Tu vivras pour le regretter."

# game/code/d20/d20s02rn.rpy:269
translate french d20s02rn_d6cb77ab:

    # rn "Although you might stop breathing."
    rn "Même si tu pourrais arrêter de respirer..."
...
translate french d20s02rn_b9ec4196:
    ...
    rn "Salope à sperme est qui tu seras, même après que je me sois lassé de toi et que je t'aurai foutu dans une benne à ordures."

# game/code/d20/d20s02rn.rpy:349
translate french d20s02rn_6abf5fde:

    # mct "Fuck. This can't be what she came prepared for."
    mct "Putain. Ça ne peut pas être ce pour quoi elle s'est préparée."

# game/code/d20/d20s02rn.rpy:350
translate french d20s02rn_c1230356:

    # mct "I didn't mean to ask this much of her."
    mct "Je ne voulais pas lui demander autant."
...
translate french d20s02rn_0c95cb0e:
    ...
    mct "Techniquement, il la pénètre, mais ce n'est que sa bouche.{w} Ça pourrait suffire."
...
translate french d20s02rn_cont_anal_72eac0f6:
    ...
    rn "Il est temps que j'essaye l'autre bout."
...
translate french d20s02rn_cont_anal_3e913745:
    ...
    rn "Ne me mens pas, Salope à sperme.{w} Je suis sûr que tous tes trous ont été bien utilisés et abusés."

# game/code/d20/d20s02rn.rpy:385
translate french d20s02rn_cont_anal_4b2d4a9b:

    # mk "I'm sorry, Master."
    mk "Je suis désolée, Maître."
...
translate french d20s02rn_cont_anal_914d77d6:
    ...
    rn "Mieux.{w} À l'avenir, reste lubrifié et préparé."
...
translate french d20s02rn_cont_anal_4465365f:
    ...
    mct "Elle a dit que ça pourrait arriver.{w} Il lui baise le cul. Je pourrais les interrompre maintenant."
...
translate french d20s02rn_cont_atm_f76b2fc9:
    ...
    rn "Parce que ça va ensuite dans ta chatte sans valeur."
...
translate french d20s02rn_cont_creampie_fa36654a:
    ...
    rn "Et maintenant la preuve finale que tu m'appartiens..."
...
translate french d20s02rn_cont_creampie_9cf5f306:
    ...
    mct "C'est définitivement le moment de les interrompre."
...
translate french d20s02rn_interrupt_578e55e8:
    ...
    mc "Oh, je pense que j'en ai assez vu. J’espère que c’était suffisamment satisfaisant."
...
translate french d20s02rn_interrupt_d74dc7ec:
    ...
    rn "Assez satisfaisant. Je suis sûr que ça aura un impact positif sur ton examen d'aujourd'hui."
...
translate french d20s02rn_interrupt_2e47a424:
    ...
    mc "Je préfère penser que c'était une transaction amicale, qui influençait vos dispositons."
...
translate french d20s02rn_interrupt_eadfc703:
    ...
    mc "Bien sûr, ça pourrait devenir moins amical si nécessaire."
...
translate french d20s02rn_interrupt_ec80cef0:
    ...
    rn "Ce ne sera pas nécessaire. Tu n'auras pas à t'inquiéter de mon vote pendant ton examen."
...
translate french d20s02rn_interrupt_58241b9b:
    ...
    rn "Tu devrais savoir qu'elle s'est promise à moi. Pour être mon animal de compagnie pour l'été."
...
translate french d20s02rn_interrupt_a5fb81c9:
    ...
    mc "J'ai entendu ça. Malheureusement, elle ne t'appartient pas. Elle s'est déjà donnée à un autre propriétaire."
...
translate french d20s02rn_interrupt_b7f5133f:
    ...
    rn "C'est vrai?{w} Je serais prêt à négocier avec toi."
...
translate french d20s02rn_interrupt_54a8c9a6:
    ...
    rn "En supposant que tu réussisses, M. Young. J'attends avec impatience ta présence dans mes cours le semestre prochain."
...
translate french d20s02rn_interrupt_1694a9c3:
    ...
    rn "Quant à ta compagne Je n'aime pas être utilisé, dupé, et trahi... \"Maria\"."
...
translate french d20s02rn_interrupt_eaf2e608:
    ...
    mk "Je n'avais pas réalisé que je l'induisais en erreur. Je pensais que la seule manière de t'aider..."
...
translate french d20s02rn_interrupt_511e08d1:
    ...
    mc "Je sais.{w} Je ne laisserais jamais ça arriver à un de mes amis."
...
translate french d20s02rn_interrupt_c068df40:
    ...
    mc "Je sais.{w} Heureusement, je me suis souvenu de ce que tu as promis à AmRose."
