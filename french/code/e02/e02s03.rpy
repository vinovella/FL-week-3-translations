...
translate french e02s03_da344b59:
    ...
    mc "J'ai oublié de te féliciter."
...
translate french e02s03_b500409f:
    ...
    mc "Pour la branler que tu m'as mis aux échecs après notre retour des pistes."
...
translate french e02s03_c0728224:
    ...
    mh "Haha. Merci. En toute honnêteté, je pense que tu étais un peu distrait."

# game/code/e02/e02s03.rpy:48
translate french e02s03_1fb28747:

    # mc "Mmmhmmm. Hard to concentrate on an empty stomach."
    mc "Mmmhmmm. Difficile de se concentrer le ventre vide."
...
translate french e02s03_61d58146:
    ...
    mc "Même si j'ai perdu, j'ai quand même apprécié. Quand nous jouions aux cartes Against Humans, c'était un de ces moments où j'ai appris à te connaître, Lyssa."
...
translate french e02s03_db00bc0f:
    ...
    mh "Oui, c'était un moment merveilleux. Tu sais que c'est dommage que nous n'ayons pas pris le jeu."
...
translate french e02s03_19521bee:
    ...
    mh "Ça aurait été une belle façon de briser la glace avec les autres invités."
...
translate french e02s03_2cd6b5aa:
    ...
    mh "Je pensais que tu allais parler de la difficulté d'élaborer une stratégie quand tu es assis en face de moi."

# game/code/e02/e02s03.rpy:63
translate french e02s03_aafe2bae:

    # mc "Haha. Well I figured that went without saying."
    mc "Haha. Eh bien, je pensais que ça allait de soi."
...
translate french e02s03_68be1d6c:
    ...
    mh "On aurait dû apporter un jeu de société. Ce serait la stratégie parfaite pour aider à briser la glace avec les autres invités."

# game/code/e02/e02s03.rpy:68
translate french e02s03_1338d306:

    # mc "Totally. But you know me. I make friends easily."
    mc "Totalement. Mais tu me connais. Je me fais facilement des amis."
...
translate french e02s03_04132ab2:
    ...
    ac "Frank, ce sont nos premières vacances depuis des années. On a à peine du temps pour nous..."

# game/code/e02/e02s03.rpy:110
translate french e02s03_ad2f759a:

    # ac "Raising a child is a huge responsibility."
    ac "Élever un enfant est une énorme responsabilité."
...
translate french e02s03_a8b3c1bc:
    ...
    fc "Alors nous allons trouver des aides. Je peux demander à Bill s'il connaît quelqu'un qui cherche du travail."

# game/code/e02/e02s03.rpy:117
translate french e02s03_e25a0a7c:

    # ac "How are we going to afford that?"
    ac "Comment allons-nous nous permettre ça?"

# game/code/e02/e02s03.rpy:120
translate french e02s03_e0e3b8b1:

    # fc "We'll... oh. Um well we will figure it out."
    fc "Nous allons... Oh. Eh bien, nous allons trouver une solution."
...
translate french e02s03_23541b73:
    ...
    mh "Lyssa. C'est mon petit ami, [mcname]"
...
translate french e02s03_6cb57fc1:
    ...
    ac "Tout le plaisir est pour moi."
...
translate french e02s03_d8f1c051:
    ...
    fc "Alors c'est un voyage avant les fiançailles? Ou êtes-vous ici tous les deux pour les séances?"

# game/code/e02/e02s03.rpy:167
translate french e02s03_be570cb2:

    # mc "It's our first big trip together. It's been amazing."
    mc "C'est notre premier grand voyage ensemble. C'est incroyable ici."
...
translate french e02s03_a761bbca:
    ...
    fc "Ah, mon erreur. Je peux le voir maintenant, cette lueur sur vous deux."

# game/code/e02/e02s03.rpy:173
translate french e02s03_db5d7606:

    # fc "Well I'm still happy to meet you, we came up here for-"
    fc "Eh bien, je suis toujours heureux de vous rencontrer, nous sommes venus ici pour-"
...
translate french e02s03_0dfc37df:
    ...
    ac "N'ennuie pas nos nouveaux amis."
...
translate french e02s03_82e96d40:
    ...
    fc "Je dis juste qu'ils ont l'air très heureux. Et que je pensais qu'ils n'étaient pas venus pour la thérapie de couple'."
...
translate french e02s03_c1a79757:
    ...
    ac "Ahem... Oui. C'est la principale raison pour laquelle nous sommes venus ici."
...
translate french e02s03_573c9751:
    ...
    fc "Ouais, mais ce n'est pas vraiment une vraie thérapie. Le thérapeute a été blessé donc il est peu probable qu'il s'en sorte ici."
...
translate french e02s03_1b4d2edb:
    ...
    fc "Mais nous avons parlé aux autres couples et avons toujours essayé de... je ne sais pas, de partager et de trouver des solutions."
...
translate french e02s03_2c7c87ef:
    ...
    fc "C'est gentil, mais je pense que ça irait. Surtout si tu as rencontré les autres couples."

# game/code/e02/e02s03.rpy:205
translate french e02s03_1f215d3a:

    # fc "It's all been very casual, no stress."
    fc "Tout est très décontracté, pas de stress."
...
translate french e02s03_86f8c829:
    ...
    ac "Nous essayons de nous concentrer sur nos problèmes, mais bon... parfois nous nous concentrons uniquement sur ceux-là, au lieu de solutions."
...
translate french e02s03_b406be32:
    ...
    mh "Eh bien, si ça ne te dérange vraiment pas, nous penserons à passer."

# game/code/e02/e02s03.rpy:223
translate french e02s03_c0e25008:

    # mct "We will? I didn't picture Lyssa as a people watcher."
    mct "On le fera? Je n'imaginais pas Lyssa comme une observatrice."
...
translate french e02s03_80c27b93:
    ...
    mh "*Chuchote* Dans l'ensemble, je suis sûr que nous finirons juste par nous retrouver avec eux pour les aider à améliorer leur séjour puisque le thérapeute n'a pas pu le faire."

# game/code/e02/e02s03.rpy:237
translate french e02s03_05d71477:

    # mct "Even on a trip, Lyssa still likes to help people in need."
    mct "Même en voyage, Lyssa aime toujours aider les gens dans le besoin."

# game/code/e02/e02s03.rpy:239
translate french e02s03_dc4e7f8c:

    # mc "Sounds like a plan, gorgeous."
    mc "Ça ressemble à un plan, magnifique."
...
translate french e02s03_lodge_02f7b642:
    ...
    mc "Hmmm. Je sais que tu as tes règles, mais tu pourrais envisager de les enfreindre."
...
translate french e02s03_lodge_6fe05156:
    ...
    mh "Haha. Je fais ce voyage sans fil. Pas de bips ni de vibrations. Juste des gémissement et halètement."
...
translate french e02s03_lodge_14d0faf3:
    ...
    mc "J'adore le son de ça, mais ces textos, eh bien, ils commencent à s'accumuler."
...
translate french e02s03_lodge_f5d59589:
    ...
    mh "Je suis sûr que ça peut être géré. Après la fin de nos vacances."
...
translate french e02s03_lodge_dc87f539:
    ...
    mh "Oliver peut gérer les choses. Je pense que son anxiété est juste exacerbée parce que je l'ai laissé seul au bureau."
...
translate french e02s03_lodge_73576b19:
    ...
    mh "A notre retour, je ne manquerai pas de le remercier pour tout le travail supplémentaire qu'il a accompli."

# game/code/e02/e02s03.rpy:274
translate french e02s03_lodge_3dd19c23:

    # mh "You know, after all that wine, I'm feeling a little..."
    mh "Tu sais, après tout ce vin, je me sens un peu..."
...
translate french e02s03_lodge_b87bab63:
    ...
    mc "Je veux dire, tout va être décidé ici. Pendant le tour final."
...
translate french e02s03_lodge_64ffe7e5:
    ...
    mh "Oh, comme c'est romantique. Et je suis sur le point d'être dominé... Comme une bête sauvage?"
...
translate french e02s03_lodge_3d276eaa:
    ...
    mc "Haha. Je ne suis pas une humble bête. Je suis le roi de la romance, comme Cyrano de Bergerac. C'est pour ça que tu es avec moi."
...
translate french e02s03_lodge_cb56b5eb:
    ...
    mh "*Gémit doucement* Tes doigts sont comme des petites bougies qui chatouillent mon corps."
...
translate french e02s03_lodge_1f6799f1:
    ...
    mh "Glisse-la dedans... je ne peux plus attendre..."
...
translate french e02s03_lodge_55168dd3:
    ...
    mh "Fais-moi l'amour. Fais de moi ta chose."
...
translate french e02s03_lodge_5e000df7:
    ...
    mh "Et tu es mon trésor. J'avais tellement peur que tu ne viennes pas avec moi. Je ne sais pas ce que j'aurais fait si tu avais dit non..."
...
translate french e02s03_lodge_28095bfd:
    ...
    mc "Je n'aurais jamais assez de toi. Ton visage, tes cheveux, la couleur de tes yeux."
...
translate french e02s03_lodge_c1ee3c51:
    ...
    mh "Tiens-moi. Ne me laisse jamais partir."
...
translate french e02s03_lodge_765ec487:
    ...
    mc "Putain. Je t'ai envoyé une bonne charge."
...
translate french e02s03_cum_again_77f5b9a9:
    ...
    mh "Ça fait {b}TELLEMENT{/b} de bien. Ça me coupe le soufle..."
...
translate french e02s03_cum_again_016fb449:
    ...
    mh "Ta langue ...voila comme ça, continue. Tu deviens tellement doué pour ça!"
...
translate french e02s03_cum_again_81b46df7:
    ...
    mh "Qu'est-ce que tu fais, homme sauvage?"
...
translate french e02s03_cum_again_3e026c53:
    ...
    mh "Je... je dois admettre... c'était l'une des choses les plus coquines que j'ai faites."

# game/code/e02/e02s03.rpy:501
translate french e02s03_cum_again_f253d1b1:

    # mc "Mmm... give me time, I'm sure I'll top that."
    mc "Mmm... donne-moi du temps, je suis sûr que je vais surpasser ça."
...
translate french e02s03_end_eb1a1071:
    ...
    mc "Fais de beaux rêves, ma chérie."
...
translate french e02s03_end_152bc6cb:
    ...
    mh "Mmm. Après ça, je suis sûr que je rêverai de toi, mon amour..."

translate french strings:

    # game/code/e02/e02s03.rpy:248
    old "In the lodge"
    new "Dans le logement"

    # game/code/e02/e02s03.rpy:442
    old "I think I can make you cum again"
    new "Je pense que je peux te faire jouir à nouveau"
