...
translate malay strings:
    ...
    new "Program ini mempuyai perisian percuma dibawah sejumlah bilangan lesen, termasuk Lesen MIT dan Lesen Awam Umum GNU. Untuk senarai lengkap perisian, juga kod sumber penuh perisian, ianya boleh didapati di {a=https://www.renpy.org/l/license}sini{/a}."
    ...
    new "TKemas kini telah dipasang. Program ini akan dimulakan semula..."
    ...
    new "Perubahan akan berkuat kuasa apabila program ini dijalankan seterusnya."
    ...
    new "Komputer ini menggunakan pemaparan perisian."
    ...
    new "Komputer ini menghadapi masalah memaparkan grafik: [problem]."

    # renpy/common/00gltest.rpy:255
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Pemacu grafiknya mungkin sudah lapuk atau tidak beroperasi dengan betul. Ini boleh menyebabkan paparan grafik yang perlahan atau tidak betul."
    ...
    new "Teruskan, Tunjukkan amaran ini sekali lagi"

    # renpy/common/00gltest.rpy:273
    old "Continue, Don't show warning again"
    new "Teruskan, Jangan tunjukkan amaran lagi"

    # renpy/common/00gltest.rpy:281
    old "Change render options"
    new "Tukar pilihan paparan"

    # renpy/common/00gamepad.rpy:32
    old "Select Gamepad to Calibrate"
    new "Pilih Pad Permainan untuk Ditentukur"
    ...
    new "Membuka fail traceback.txt dalam editor teks."
    ...
    new "Menyalin fail traceback.txt ke papan keratan sebagai BBcode untuk forum seperti https://lemmasoft.renai.us/."
    ...
    new "Menyalin fail traceback.txt ke papan keratan sebagai Markdown untuk Discord."
    ...
    new "Cuba untuk mengembalikan ke masa sebelumnya, membolehkan anda menyimpan atau memilih pilihan lain."
    ...
    new "Abaikan pengecualian, membolehkan anda meneruskan."

    # renpy/common/_errorhandling.rpym:626
    old "Ignores the exception, allowing you to continue. This often leads to additional errors."
    new "Abaikan pengecualian, membolehkan anda meneruskan. Ini sering membawa kepada ralat tambahan."
    ...
    new "Muat semula permainan dari cakera, menyimpan dan memulihkan keadaan permainan jika boleh."
    ...
    new "Membuka konsol untuk membenarkan penyahpepijatan masalah."
