...
translate korean e01s02_c765f27b:
    ...
    sy "아냐, 바보야. 전철 타고 몇 정거장만 가면 돼. 도시 안이라서 얼마 안 걸려."
...
translate korean e01s02_d7e307e4:
    ...
    mc "장난이야. 알잖아. 나한테 가장 소중한 사람은 너인걸."
...
translate korean e01s02_d647c5ff:
    ...
    mc "밤이 되면 곁에서 자고 싶고 낮이 되면 곁에서 일어나고 싶은 사람은 너뿐이야."
...
translate korean e01s02_9cef3f26:
    ...
    sy "근데, 제대로 일을 하면 연봉도 많이 받을 거 아냐. 거기다 통화 팽창에 이런 저런 일도 있을 테니까, 너라면 일흔이 되기 전까지 수백만 달러는 너끈히 벌 거라구."
...
translate korean e01s02_d45a66d7:
    ...
    mc "알겠어, 알겠어. 그럼, 복권이 당첨되거나 카지노에 가서 한탕 해서 왕창 벌었다고 치자."
...
translate korean e01s02_0c1fa20a:
    ...
    sy "어찌 됐든 간에 그렇게 해서, 다시는 일할 필요가 없을 정도 많은 돈을 벌게 된 거야."
...
translate korean e01s02_d094470a:
    ...
    mc "그럼 똑똑하게 굴어야지. 변호사를 사서 대비부터 하겠어. 꾼들이 날 표적으로 삼기 전까지 몇 달은 벌 수 있겠네."
...
translate korean e01s02_cf421ca5:
    ...
    mc "친척이라는 작자들이 난데없이 나타나선 사업 자금으로 몇천이니 십만이니 대 달라고 하겠지."
...
translate korean e01s02_e7c95eb8:
    ...
    mc "식료품 점에 갈 때마다 보험 사기꾼들이 다친 척하면서 날 고소하려고 들 테고."
...
translate korean e01s02_08cc5e15:
    ...
    mc "거기에 나랑 섹스한 모든 여자들이 나한테 뭐라도 빼먹으려고 하는 건 말할 필요도 없겠네."
...
translate korean e01s02_73b4c8d5:
    ...
    mc "그 놈의 백만 달러가 다 떨어질 때까지 사막의 모처에서 특별 배달부가 가져온 음식으로 연명하겠지."
...
translate korean e01s02_e49de7e0:
    ...
    sy "설정 좀 바꿔 보자. 횡재해서 돈을 왕창 벌으면 어떻게 할 거냐는 이야기는 잊으라구. 바라는 일이 뭐든지 할 수 있다면, 뭘 할래?"
...
translate korean e01s02_3498fe23:
    ...
    mc "진지하게 하는 말이야. 내가 원하는 사람이 누구든지 함께할 수 있다는 걸 알게 되었거든. 그래서 하던 대로 하겠다는 거야."
...
translate korean e01s02_2ff81412:
    ...
    mc "그럼 질문을 이렇게 바꿔 보자구. 네가 원하는 건 뭐든지 할 수 있게 무한한 부와 능력이 주어진다고 하면, 뭘 할래로?"
...
translate korean e01s02_e9770062:
    ...
    sy "볼 장 봤으면서 필요한 거처럼 말한다. 아무튼, 조사 목적으로 압수한 거니까 그렇게 알고 있어."
...
translate korean e01s02_cccc4977:
    ...
    mc "그래, 그래라. 그럼 네 기본 계획의 첫 부분은 뭔데."
...
translate korean e01s02_420e1232:
    ...
    sy "물론, 너지. 이제 넌 내 거니까, 계획의 두 번째 부분으로 이행할 수 있게 됐다구."
...
translate korean e01s02_c0c6d182:
    ...
    sy "방금 말한 거처럼, 우린 우리만의 포르노 제작소를 열어."
...
translate korean e01s02_cccd224a:
    ...
    sy "화면으로 뒤로 하는 일은 다 내가 처리하고, 넌 주인공이 되는 거지."
...
translate korean e01s02_d37b60a2:
    ...
    sy "그러니까, 우리한텐, 카메라, 조명, 배우, 제작진, 돈, 기타 등등이 필요해."
...
translate korean e01s02_f818b4a2:
    ...
    sy "아니, 말했잖아. 거의 다 내가 준비하겠다고. 일은 분담해야지."
...
translate korean e01s02_27728f0f:
    ...
    sy "아, 그 부분이 가장 중요해! 내가 새로운 인재들을 모집하는 데 도움이 될 만한 정보도 다 모아 뒀어."
...
translate korean e01s02_19c51089:
    ...
    sy "오해하진 마라. 난 사람들이 직접 올린 사진이랑 영상 보는 걸 즐겼을 뿐이니까."
...
translate korean e01s02_ca1fbc38:
    ...
    mc "보는 덴 크게 반대는 안 하는데... 그래도 좀 그렇지 않냐?"
...
translate korean e01s02_7d0d944d:
    ...
    sy "그러니까, 사진이랑 영상이야 딸치고 재미 보는 데 좋지. 그런데, 알맹이는 메타데이터야."
...
translate korean e01s02_880d2eb6:
    ...
    sy "사진과 영상에 관한 메타데이터. 누구 했는가. 어디에서 했는가. 뭘 했는가. 그런 데이터를 말하는 거야."
...
translate korean e01s02_c6435fd2:
    ...
    mc "그런데 우리 전부 가명을 사용했잖아. 게다가 하는 사람 중엔 가면이나-"
...
translate korean e01s02_eaa6cff7:
    ...
    sy "리디아가 사회적 집합체에 관해 이야기 한 거 기억해?"
...
translate korean e01s02_387aff78:
    ...
    sy "난 성적인 사람들이 함께하는 장소를 식별할 수 있다고 봐."
...
translate korean e01s02_5e7921d9:
    ...
    sy "아니. 나도 고민을 해 봤는데, 데이터상으론 그렇지가 않더라."
...
translate korean e01s02_7a974976:
    ...
    sy "내가 조사를 해 왔걸랑. 인터넷으로 찾아보기도 하고, 다양한 데이터베이스로 교차 검증도 해 보고..."
...
translate korean e01s02_aa1c2593:
    ...
    sy "페티시 로케이터의 데이터베이스를 복사하고 싶었던 건 다 이유가 있었단 말씀이야."
...
translate korean e01s02_a405cbb3:
    ...
    sy "메타데이터. 위치. 모호한 정보. 사람 한 명 추적하는 데 쓸 수는 없는 것들."
...
translate korean e01s02_82a424e4:
    ...
    sy "전부 버릴 순 없으니까. 다음 계획에는 그 데이터가 필요하단 말이야."
...
translate korean e01s02_d1c1e9db:
    ...
    sy "우리의 포르노 제작소를 함께 꾸려 나가기. 사람들을 찾기 위해 가야 하는 곳도 다 찾아 뒀으니까, 가서 네 마술을 부려 봐."
...
translate korean e01s02_55c96b26:
    ...
    sy "거의 모든 일은 우리 둘이서 하긴 해. 나머지 일은... 내가 유망한 배우를 찾고, 네가 가서 유혹해서, 너랑 섹스하도록 유도하면... 그다음엔 우리가 그걸 촬영하는 거지."
...
translate korean e01s02_a064a748:
    ...
    mc "찍히는 사람한테 알려 주지도 않고 섹스하는 모습을 찍으면 안 된다고!!! 그런 짓은 끔찍한 거야!!!"
...
translate korean e01s02_f9476b57:
    ...
    sy "난 그렇게 말한 적은 없다. 당연히 가명으로 동의도 받고 합의서도 작성할 거야."
...
translate korean e01s02_cf83b3f1:
    ...
    sy "그러긴 했지. 그치만 전문가 수준의 장비, 진짜 촬영 기사, 여러 명의 배우가 있으면 어떨지 생각해 봐!"
...
translate korean e01s02_e0e15ae9:
    ...
    mc "좋은 생각이긴 하네. 성벽은 정말 많지만, 성벽만 하나하나 다루는 게 주류라곤 할 수 없으니까."
...
translate korean e01s02_b7dbe3cb:
    ...
    sy "정확해, 우린 만인이 우리를 통해서 모든 성적 취향을 채울 수 있는 제작사가 될 거야!"
