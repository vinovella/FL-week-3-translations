...
translate korean e02s04_cf37f363:
    ...
    mc "나도 그래 봐야겠다. 리사의 곁에 있는 거. 재판 중에 말이야."
...
translate korean e02s04_d792eb3d:
    ...
    mh "[mcname], 내가 당신을 사랑하긴 하지만, 법을 좋아한다는 것과 법을 일로 삼는다는 것 사이엔 {i}아주 큰{/i} 간극이 있어."
...
translate korean e02s04_cdd817d4:
    ...
    mh "그런 말장난은 침실에서 먹히지, 제 사무실에선 먹히지 않는답니다."
...
translate korean e02s04_06a5d34c:
    ...
    mh "선생님께서는 진작 패소하셨답니다. 이런 섹시한 수습 직원이 옆에 있으면, 난 일이라곤 전혀 할 수 없다구."
...
translate korean e02s04_photo_8831022a:
    ...
    ap "아, 정말 죄송합니다. 제 아내가 사진을 찍어 달라고 했는데, 제가 제대로 찍질 못했네요."
...
translate korean e02s04_photo_97733348:
    ...
    mh "잠깐만, 누구신지 알겠네요. {w}채널 식스에서 일하시는 알렉산더 포틸로 씨, 맞으시죠?"
...
translate korean e02s04_photo_a2b13b41:
    ...
    mh "만나서 반갑습니다. 이 사람은 제 남자 친구, [mcname]입니다. 이제 그 사진은 지워 주실 수 있겠죠?"
...
translate korean e02s04_photo_9c8529b9:
    ...
    atp "하하. 그렇죠. 그럼, 괜찮다면 같이 이야기 좀 해도 될까요?"
...
translate korean e02s04_photo_139c290f:
    ...
    mh "네. 그런데 소개부터 새롭게 다시 시작하지 않겠어요? 전 리사라고 해요. 그리고 이이는 제 남자 친구인, [mcname]."
...
translate korean e02s04_fireplace_af7148fc:
    ...
    atp "그래서 당신 조수도 알고 법원에 있는 그 많은 사람들한테도 말했다라... 그런데 신경 쓰지 않았다구요?"
...
translate korean e02s04_fireplace_e4778d74:
    ...
    atp "어떨 땐 비밀로 해 둘 껄 싶다니까요. 직장에서 밝히고 나니까 나한테 이상하게 구는 종자들이 있단 말이죠."
...
translate korean e02s04_fireplace_3aa7a0f8:
    ...
    atp "...나한테 따라다니는 별명은 여전히 그놈의 \"종마\" 같은 거라니."
...
translate korean e02s04_fireplace_ad95afc1:
    ...
    mh "자신을 밝힌 용기, 대단하다고 생각해요. 전... 제가 드릴 수 있는 조언은 구제 불능인 사람들에게 신경 쓰지 말라는 거예요."
...
translate korean e02s04_fireplace_df2927f3:
    ...
    mh "쉽지 않은 일이라는 점 잘 알아요. 안젤라 씨를 인정하는 사람이 많아질수록, 신상에 관해서 알게 되는 사람도 많아지고, 바보들도 나타나니까요."
...
translate korean e02s04_fireplace_398f637e:
    ...
    atp "이렇게 터놓고 이야기하니 속이 다 트이네요. 그리고 어... {w}아까 일도 다 참아 주셔서 고마워요."
...
translate korean e02s04_fireplace_78ac8cc7:
    ...
    mc "그럼 안젤라가 뉴스를 운영하지만 알렉산더가 뉴스를 진행하는 식인가요?"
...
translate korean e02s04_fireplace_e3956977:
    ...
    mc "와우. 정말... 거의 완전 다른 사람처럼 목소리가 변하시는데요. 괜찮네요."
...
translate korean e02s04_fireplace_012064ef:
    ...
    atp "이 '황금 목소리'는 내가 딜도로 엉덩이를 쑤실 때도 줄줄 새어 나오던데."
...
translate korean e02s04_fireplace_b148fed4:
    ...
    ap "두 분 모두 저희 이야기를 잘 들어 주셨지만, 이런 주제에 관해선 불편하시겠죠."
...
translate korean e02s04_fireplace_d0d86538:
    ...
    atp "그럼, 말해 봐요, [mcname]... 그쪽은 다른 쪽도 즐겨요? 말하자면, 리사가 운전대 잡는 거 말이에요?"
...
translate korean e02s04_fireplace_9b041e14:
    ...
    atp "너무 기다리게 하진 마세요. 리사도 그쪽 뒷문 쓰고 싶어할 테니까 말이에요, [mcname]"
...
translate korean e02s04_fireplace_004def0a:
    ...
    atp "물론 그렇죠. 근데 다른 사람 손에 이끌려서야 새로운 경험을 할 수 있는 사람, 모험이나 도전을 꺼리는 사람이 있잖아요."
...
translate korean e02s04_fireplace_1efb1360:
    ...
    ap "그렇다고 나라고 매일 당신 자지에 끌려다니고 싶진 않거든, 안젤라."
...
translate korean e02s04_fireplace_bc655e72:
    ...
    ap "그런 말이 아니잖아. 이래서- *한숨* 이거 때문에 여기 온 거잖아."
...
translate korean e02s04_fireplace_cf283332:
    ...
    mc "{size=-10}*속삭임* 우리 체스나 한 판 더 하러 가야겠다는 생각이 드는데.{/size}"
...
translate korean e02s04_fireplace_8669d6dd:
    ...
    mh "{size=-10}*속삭임* 난 지금 놀 기분이 아닌걸.{/size}"
...
translate korean e02s04_fireplace_a5d57ad0:
    ...
    mc "{size=-10}*속삭임* 좋아... 그러면 우리가 어떻게 도울 수 있을까?{/size}"
...
translate korean e02s04_fireplace_b4c7b8d5:
    ...
    mh "두 분 상담가 말씀하셨죠. 연인 대상 상담 때문에 오시게 된 건가요?"
...
translate korean e02s04_fireplace_97e3c859:
    ...
    mc "그래도 여기가 스노보드 타기엔 엄청 좋더라구요. 상담 때문이 아니더라도 괜찮은 휴가를 보내실 수 있을 거예요."
...
translate korean e02s04_fireplace_c1693c5f:
    ...
    mh "아, 아니에요. 하지만 법원에서 사람들의 여러 모습을 아주 잘 봐 왔으니까요. 제가 조언을 드릴 수도 있겠네요."
...
translate korean e02s04_fireplace_0061d983:
    ...
    mh "안젤라 씨의 부군은 전하고 싶은 바가 있어요. 불편한 이야기일 수도 있겠지만, 가감 없이 말씀 드리죠. 알렉산더 씨..."
...
translate korean e02s04_fireplace_6eccf0e9:
    ...
    mct "리사가 활약하는 모습을 보는 건 눈에 호강이라니까."
...
translate korean e02s04_fireplace_5cd03cbe:
    ...
    mh "그리고 안젤라 씨는 정반대예요. 활력이 넘치고, 마음에 있는 바는 바로 말해요."
...
translate korean e02s04_fireplace_1d77236e:
    ...
    mh "직업에 완벽히 맞는 성격이네요. 안젤라 씨는 항상 주도권을 잡죠."
...
translate korean e02s04_fireplace_88886ab0:
    ...
    mh "법정에서 변호사와 의뢰인이 서로에게 솔직하지 않으면, 승소할 수 없어요."
...
translate korean e02s04_fireplace_b4c98586:
    ...
    mh "두 사람 사이엔 표면에 드러내지 않은 깊은 문제가 있어 보이네요."
...
translate korean e02s04_fireplace_d4a7a895:
    ...
    ap "참을성 있게 들어 주셔서 감사합니다. 그리고 어... 방금 이야기는 비밀로 해 주세요."
...
translate korean e02s04_next_day_14ba5475:
    ...
    mc "이른 시간이지. 벌써 다 쉰 느낌이네. {w}이 침대는 끝내 준다니까."
...
translate korean e02s04_next_day_12a093f5:
    ...
    mh "제대로 된 휴가는 정말 오랜만인데. {w}{i}정말{/i} 긴급한 문제일까?"
...
translate korean e02s04_next_day_ab5dc583:
    ...
    mc "리사, 중요하지 않은 문제였으면 올리버가 이렇게까지 연락을 하려고 애를 쓰진 않았을 거라고 봐."
...
translate korean e02s04_next_day_4b9c519b:
    ...
    mc "괜찮아, 리사. 일에 잠시 눈 돌리는 정도야, 어제부터 우리가 빠지고 있는 늪에 비하면야 아무것도 아니라구."
...
translate korean e02s04_next_day_aed80020:
    ...
    mh "우리 둘 다 그렇지. 아까 한 말이 두 사람한테 도움이 될까? 안젤라 씨와 알렉산더 씨."
...
translate korean e02s04_next_day_2_79cbd550:
    ...
    ms "안녕하세요. 저희는 저기 옆 방갈로에 지내는 사람들이에요. 전 미카엘라고, 이쪽은 도로시예요."
...
translate korean e02s04_next_day_2_3a19e63d:
    ...
    ms "도로시는 나중에 말을 걸어 보자고 했는데, 저는 슬로프로 가기 전에 두 사람과 이야기를 나누면 좋을 것 같더라구요."
...
translate korean e02s04_next_day_2_b49038fa:
    ...
    mh "전 리사고 이이는 제 남자 친구예요. 밖은 추우니 안에서 이야기하죠."
...
translate korean e02s04_next_day_2_8a465964:
    ...
    ms "구조야 같죠. 근데 우리 쪽은 바람이 많이 불어요. 튼튼하기야 한데, 냉기가 벽으로 스며든다니까요."
...
translate korean e02s04_next_day_2_e054e66b:
    ...
    ms "일장일단이야 있죠. 춥지 않았으면, 사우나를 즐기진 못했을 테니까요."
...
translate korean e02s04_next_day_2_30d577e6:
    ...
    mh "그럼 두 분이 이렇게 일찍 저희를 찾으신 이유를 알 수 있을까요?"
...
translate korean e02s04_next_day_2_69036438:
    ...
    mc "아니요. 오해예요. 그러니까, 묘하게 들릴 지도 모르겠는데, 흥미로운 한 쌍이더라구요. 이상한 사람들은 아니었어요."
...
translate korean e02s04_next_day_2_88ec7067:
    ...
    ms "그런데 두 사람은 편해 보이네요... 다른 사람이랑 관계에 대해 이야기하는 데 거부감이 없나 봐요?"
...
translate korean e02s04_next_day_2_ddbf3d42:
    ...
    dn "아... 이제 이해가 좀 되네요. 다음 모임엔 그 부부도 불러야겠네요."
...
translate korean e02s04_next_day_2_24c86245:
    ...
    ms "좋네요. 만난 뒤로 우리들끼리 상담 모임을 하고 있거든요."
...
translate korean e02s04_end_ecaafca1:
    ...
    mc "우리 빼고 여기 온 사람들은 다 상담 받으러 온 모양이네."
...
translate korean e02s04_end_a69c749b:
    ...
    mh "오늘은 알게 된 내용을 정리하고 모임에 참여해 봐야지. 다시 당신 휴대폰 빌릴게, [mcname]."
...
translate korean e02s04_end_e6035d91:
    ...
    mc "아니, 꼭 그런 건 아닌데. 뭐라고 할까... 좀 흥미롭네."
...
translate korean e02s04_end_b35bb58c:
    ...
    mc "만인에겐 사랑할 자격이 있으니, 우리가 사람들의 문제를 해결해 줄 수 있다면, 기꺼이 해야지."
...
translate korean e02s04_end_7361cd1d:
    ...
    mh "훌륭해. 준비하는 동안 누구에게 초점을 맞출지 고민해 보자."
