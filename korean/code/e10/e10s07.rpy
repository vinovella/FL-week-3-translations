...
translate korean e10s07_7d19c50d:
    ...
    md "돕고 말고 하는 것보다 더 중요한 일이다. 너희가...{w} 즐거워 할 만한 몇 가지 안 건이 있어서 말이다."
...
translate korean e10s07_0d77f5b1:
    ...
    md "그 회사도 나에겐 이야기도 하지 않고 시작하지 않았더냐. 그러니 전에 너희에게 알릴 의무는 없지."
...
translate korean e10s07_4003e446:
    ...
    md "놀라울 정도로 쉽더구나. 너희 직원들도 자기 회사 주식을 바로 현금화하고 싶어하는 모양이니."
...
translate korean e10s07_2a65a980:
    ...
    mct "놀랍지도 않지. 다른 스타트업도 다 그렇겠지만, 거래가 들어 오지 않는 이상 직원들은 우리 사주를 껌값 정도라고 생각했을 테니까."
...
translate korean e10s07_56e35683:
    ...
    md "내 제안은 이렇다.{w} 다음 이사회가 모인 자리에서 내가 주주의 한 사람이라는 사실을 밝히겠다."
...
translate korean e10s07_facf1ccf:
    ...
    mc "알겠습니다. 이사회 의장이 따님인 점은 알고 계시죠?"
...
translate korean e10s07_c87317e7:
    ...
    md "알다마다, 자네도 CEO로서 주식은 가지고 있겠지. 내 제안이 모두에게 이익이 된다는 점은 잘 알 거다."
...
translate korean e10s07_4c9e924d:
    ...
    mes "아버지는 자기 회사의 완전 자회사로서 우리 회사를 바꾸고 싶으신 거잖아요."
...
translate korean e10s07_e23d2d85:
    ...
    md "[mcname], 자네가 원한다면 CEO도 남아도 좋네. 하지만 우리 쪽에서 고용한 전문가들이 자네의 어중이떠중이 직원들보다 더 뛰어날 거야."

# game/code/e10/e10s07.rpy:67
translate korean e10s07_d5f76cc2:

    # mes "[mcname] is the CMO, I am CEO."
    mes "[mcname] 이 사람은 CMO라구요. 제가 CEO에요."
...
translate korean e10s07_48d44569:
    ...
    mes "아버지는 제가 다시 아버지 밑에서 일할 거라고 생각하세요? 퇴사하기 전의 자리로 돌아갈 거라구요?"
...
translate korean e10s07_35d4450e:
    ...
    mc "저희는 이미 성공적인 사업체를 세웠습니다. 그리고 더욱 성공하기 위한 분명한 목표를 가지고 있습니다."
...
translate korean e10s07_4ba9f6df:
    ...
    mc "저는 아버님을 모욕할 생각은 없었어요. 존경심의 발로로 말씀 드렸을 뿐입니다."
...
translate korean e10s07_168859aa:
    ...
    mc "저희는 훈육이 필요한 아이들이 아닙니다. 만약 은수를 돌 봐 줄 사람이 필요하다면 동반자인 제가 있습니다."

# game/code/e10/e10s07.rpy:149
translate korean e10s07_4d293f34:

    # mc "This is about family. You have a choice."
    mc "이제 선택을 하셔야 합니다. 아버지와 장인어른으로 남을지, 아니면 그저 불쾌한 적대적 인수자가 되실지."
...
translate korean e10s07_746e5445:
    ...
    mm "안 할 이유라도 있니? 난 한상 손주를 보고 싶었단다. 게다가 네 오빠는 사람 만날 생각도 전혀 안 하니 기댈 사람을 너뿐이란다."
...
translate korean e10s07_1bf1ef60:
    ...
    mb "저는요, 일에 집중하고 있을 뿐이라구요. 사람 사귀는 건 나중에 해도 되잖아요."
...
translate korean e10s07_d135212a:
    ...
    mm "자네, 불임은 아니고, 남자는 맞지? 불임에 남자가 아니라면 허락은 어려워."

# game/code/e10/e10s07.rpy:175
translate korean e10s07_ebb442bd:

    # mc "What? No."
    mc "예? 그런 염려는 안 하셔도 돼요."
...
translate korean e10s07_756b3108:
    ...
    mm "내가 너희에게 말을 했는지 모르겠네. 결혼식 날 밤에 너희 아빠 본 기억이 나네-"
...
translate korean e10s07_a37fe0e9:
    ...
    mm "물론 해 줄게. 두 사람이 곧 국수를 먹게 해 준다는 게 너무 기쁘구나. 내 딸이 아주 좋은 남편감을 만났어."
...
translate korean e10s07_631c99ed:
    ...
    mm "음, 더 좋은 남편감이 있을지도 모르지만, 그래도 자네만큼 우리 딸한테 어울리는 사람을 없을 거야."
...
translate korean e10s07_ef6bf00a:
    ...
    mm "알겠어, 그럼 입 맞추는 건 둘이서 알아서 하렴. 나는 조용히 있으마."
