...
translate korean d21s02_35fb3602:
    ...
    sy "그 썅년 박살 내는 임무가 있지. 그년은 파묻히고, 관짝을 닫는 사람은 나."
...
translate korean d21s02_8cb16c49:
    ...
    sy "이제 영영 사라지는 거라구. 무기징역행 급행 열차표는 내가 끊어 줘야지."
...
translate korean d21s02_e2b47eef:
    ...
    sy "그년은 언덕 위 큰 집에, 그년 태워다 줄 택시는 나."
...
translate korean d21s02_e00c48cb:
    ...
    sy "내가 담당하게 해 줘. 난 껌이나 씹으면서 리디아를 갱생-"
...
translate korean d21s02_c7895dc4:
    ...
    "경관" "예, 칵스 씨가 선생님의 방문에 동의했습니다. 이런 말씀을 드리게 되어 아쉽습니다만, 칵스 씨는 방문자를 두 명으로 제안했습니다."
...
translate korean d21s02_d4ba5962:
    ...
    sy "내가 가게 해 줘. 내가 가게 해 줘!{w} 그 쌍년을 빵에 넣어서 손주도 못 보게 해 주겠어!"
...
translate korean d21s02_meet_lc_95b433d4:
    ...
    lc "너처럼 사람을 제대로 벗겨 먹는 버팔로 빌은 본 적이 없어."
...
translate korean d21s02_ntr_arj_4e3e9555:
    ...
    arj "스테이시에서는 큰 소리치긴 했지만, 실은 나... 무서워."
...
translate korean d21s02_ntr_arj_92a665d3:
    ...
    mc "무서운 곳이니까. 우린 언제든지 여기에서 나갈 수 있으니까 괜찮아."
...
translate korean d21s02_ntr_arj_5f52a95d:
    ...
    arj "그게 아냐. 나는 리디아가 무서워. 리디아의 본모습이 무서워. 네가 말해 준 그 모든 일을 태연하게 저지르면서도 겉으로는 저런 얼굴을 있었다는 게..."
...
translate korean d21s02_ntr_arj_0ffa9f24:
    ...
    mc "이 철창 밖에 있는 사람이 누구고 안에 있는 사람이 누군지만 기억해."
...
translate korean d21s02_ntr_arj_7287e85d:
    ...
    arj "잘 지냈냐, 쌍년아? 철창 밖에서 세상을 보니 좀 어때?"
...
translate korean d21s02_ntr_arj_7a8bceb0:
    ...
    lc "얘는, 여기서도 널 보니까 정말 좋네. 우리 남자 친구가 샘만 안 부렸어도, 지금쯤 네가 내 주스를 맛있게 먹어 줬을 텐데. 정말 아쉽다, 그치?"

# game/code/d21/d21s02.rpy:205
translate korean d21s02_ntr_arj_9510eedb:

    # arj "Fuck you. You don't know me."
    arj "좆까. 그딴 건 아쉽지도 않거든."
...
translate korean d21s02_ntr_arj_10b8f8f2:
    ...
    lc "빼기는. 말은 그렇게 해도 네가 즐겼을 거라는 건 알아. 본능이라고 할까. 아니다, 지금해도 되겠네. 거기서 날 맛봐 줄래?"
...
translate korean d21s02_ntr_arj_75d4337c:
    ...
    lc "당장 무릎 꿇고 이 철창 너머로 네 혀를 내밀어 보지 그러니."
...
translate korean d21s02_ntr_arj_b62bed16:
    ...
    arj "나 못하겠어. 이러다난 내가 저년을 죽이든지 아니면-"
...
translate korean d21s02_ntr_arj_fcfd5469:
    ...
    mc "알겠어. 나한테 몇분만 줘. 리디아랑 이야기하는 거 끝나면 바로 나가자."
...
translate korean d21s02_lc_arj_375b2126:
    ...
    lc "걱정하지 마. 우리 남자 친구 앞에선 너에 관해서 뭐 이야기할 생각은 없으니까."
...
translate korean d21s02_lc_arj_e082abc9:
    ...
    arj "그 일에 관해선 전부 잊는 게 신상에 좋을 거야. 내가 장담하겠는데 그 염병할 거에 관해서 한 마디만 더 지껄이면-"
...
translate korean d21s02_lc_arj_2646f864:
    ...
    lc "난 아무것도 안했어. 네가 그런 일을 했는지도 모르고 있었다구."
...
translate korean d21s02_lc_arj_163c57e8:
    ...
    lc "난 안 그랬어! 아마 제롬이 그랬을 거야. 아니면 그 인공 지능이 했겠지."
...
translate korean d21s02_lc_arj_1276da63:
    ...
    lc "그래도 그런 일을 겪게 해서 정말 미안해. 그래서 내가 여기에 있는 거야. 언젠간 내 진심을 알아줬으면 해."
...
translate korean d21s02_ntr_sy_61ba299b:
    ...
    lc "\"면회\"는 녹화되지도 않고, 녹음은 불법이란다. 그 사실은 알고 있니?"
...
translate korean d21s02_ntr_sy_4149803b:
    ...
    mc "그냥 내 여자 친구인지 전 여자 친구인지 모를 사람을 보고 싶었어."
...
translate korean d21s02_lc_sy_f7945636:
    ...
    sy "아니, 모든 경우의 수를 다 따졌다구. 괜찮으면 뭐 좀 물어봐도 될까?"
...
translate korean d21s02_lc_sy_7b0cf382:
    ...
    lc "글쎄, 대부분의 일은 사실 제롬이 했어. 앱도 만들었고-"
...
translate korean d21s02_lc_sy_2d81001a:
    ...
    sy "그 부분 말고. 그러니까, 어떻게 그 많은 사람이 플레이 하게 만들 수 있었나?"
...
translate korean d21s02_lc_sy_65aa357f:
    ...
    lc "아, 그 부분은 내가 했어. 이런 일은 사회적 집합체의 인지에 관한 거야."
...
translate korean d21s02_lc_sy_a04b5b81:
    ...
    mc "이미 사회가 집합이라는 의미가 있으니 겹말 같은데."
...
translate korean d21s02_lc_sy_426738d3:
    ...
    lc "맞아. 그래도 뉘앙스가 좀 다르니까. 합류점이라는 표현이 더 나을지도 모르겠다."
...
translate korean d21s02_lc_sy_1f717e5c:
    ...
    lc "모든 사회 집단에는 하나의 중심점이 있어. 경우에 따라선 다양한 사회 집단이 특정 중심점을 공유하기도 해."
...
translate korean d21s02_lc_sy_2bb3c707:
    ...
    lc "[mcname]의 사례를 좋은 예로 들 수 있어. 지난 몇주 동안 [mcname]의 사회적 집단은 폭발적으로 성장했어. 그리고 기존의 여러 사회 집단들의 중심점이 되었지. 전부 얘를 중심으로 돌아가기 시작한 거야."
...
translate korean d21s02_lc_sy_3ed137ba:
    ...
    lc "만난 모든 사람들. 영향을 준 모든 사람들. 그 사람들이 모여 하나의 거미집을 이루는 가닥이 된 거지."
...
translate korean d21s02_lc_sy_0ec81f5a:
    ...
    lc "[mcname]의 결정은 자신의 주변에 있는 모든 사람에게 영향을 미쳐."
...
translate korean d21s02_lc_sy_acd6fe78:
    ...
    sy "그래서, 너는 그 사회적 집합체인가 합류접인가 하는 사람을 찾아 페티시 로케이터를 플레이 하도록 자극했다는 소리야?"
...
translate korean d21s02_lc_sy_ecd82c3a:
    ...
    lc "나라면 영향을 주었다는 표현을 쓸게. 어떨 땐 사람, 경우에 따라선 사람들이 모이는 장소에 영향을 주었어."
...
translate korean d21s02_lc_sy_4fa2f743:
    ...
    mc "엄청 흥미로운 이야기이긴 한데... 잠시 둘이서 이야기 좀 하게 해 줄 수 있어?"
...
translate korean d21s02_lc_sy_5d288244:
    ...
    lc "처음에 거칠게 말하긴 했어도 스테이시한테 악의는 없었다고 봐."
...
translate korean d21s02_mc_ntr_f45100e6:
    ...
    lc "난 갖혀 있지. 내가 공들여 쌓아온 명성은 박살났고."
...
translate korean d21s02_mc_ntr_442f00b1:
    ...
    mc "과신이니 하는 표현은 이럴 때 쓰는 건 아닌 거 잖은데. 난 네 생각보다 강해. 그래서 네가 철창 안에 있는 거야."
...
translate korean d21s02_mc_ntr_81d80139:
    ...
    lc "하! 내 생각보다 강해? 네 사랑은 약했어. 넌 이기적이고 무정한 인간일 뿐이야."
...
translate korean d21s02_mc_ntr_ad3796df:
    ...
    mc "네 본모습이 자아도취에 사이코패스인 쌍년이라서 이렇게 된 게 내 잘못은 아니잖아."
...
translate korean d21s02_mc_ntr_ca76cc0f:
    ...
    mc "어쩌다가 이렇게 된 거야. 내가 우상처럼 모셨던 상냥한 소녀는 어디로 간 거냐고? 어쩌다가 이런 꼬일 대로 꼬인 걸레가 된 거니?"
...
translate korean d21s02_mc_ntr_11cc6509:
    ...
    lc "꼬여? 내 부모라는 인간들부터 만나보고 나보고 그딴 소리를 해."
...
translate korean d21s02_mc_ntr_42ae163d:
    ...
    lc "날 키워? 수십년 동안 그 인간들은 약이랑 술에 취해있었어."
...
translate korean d21s02_mc_ntr_1c490bd1:
    ...
    lc "날 돌보라고 사람을 산 게 다야. 가정 교사, 베이비시터. 경우에 따라선 유학 온 인간들한테 쥐꼬리 같은 돈을 주고 날 돌보게 했지."
...
translate korean d21s02_mc_ntr_921fada8:
    ...
    lc "몇몇 인간들은 몇 주는 갔지. 어떤 인간들은 몇 달은 갔고. 그래도 결국엔 전부 떠났어."
...
translate korean d21s02_mc_ntr_2abd3d33:
    ...
    lc "나 때문에. 이해를 못 하겠니? 이 세상에 날 사랑하는 사람은 없어."
...
translate korean d21s02_mc_ntr_8f33e9f0:
    ...
    lc "넌 돌아올 거야. 나 없이는 못 살잖니. 너도 알잖아."
...
translate korean d21s02_mc_lc_129ea37f:
    ...
    mc "누가 널 다치게 하진 않았고? 뭐라도 내가 도와줄 일 있을까?"
...
translate korean d21s02_mc_lc_ae51b144:
    ...
    lc "그 사람 말고는 다른 \"손님\"은 없었어. 그저 나만 이 우리에 계속 있었지."
...
translate korean d21s02_mc_lc_b071e8d2:
    ...
    mc "자백을 철회할 순 없어? 아니면 보석으로 나오는 건?"
...
translate korean d21s02_mc_lc_c4e8b9d3:
    ...
    lc "응. 그 사람은 벌금으로 끝났어. 누가 돈을 내 준 모양이야. 그리고 경찰 중에도 친구가 있는 모양이더라. 손님이려나, 잘 모르겠어."
...
translate korean d21s02_mc_lc_b8a45a19:
    ...
    lc "그 사람이 나도 잘 말해 주겠다곤 했어. 잘 하면 괜찮은 저녁이라도 나오겠지."
...
translate korean d21s02_mc_lc_aebae3fc:
    ...
    lc "제길. 나를 그런 사람이라고 생각하지 않으면 좋을 텐데... 나한테 이상한 거라도 기대하면 안 될 텐데... 그 사람이 해 주는 일 같은 걸."
...
translate korean d21s02_mc_lc_73a01bf2:
    ...
    mc "이런 일이 겪게 해서 정말 미안해. 여기서 널 나가게 해 줄 수만 있다면 뭐라도 할 텐데."
...
translate korean d21s02_mc_lc_13d8db0f:
    ...
    lc "부탁 하나 들어 수 있니? 만약 내가 보석 심리가 끝나고 진짜 교도소에 이송된다면 그때 부탁할게."
...
translate korean d21s02_mc_lc_8f4cdb3f:
    ...
    mc "너라면 이 일을 헤쳐 나갈 수 있을 거야. 무슨 일이 있어도 난 네 힘이 되 줄게."
...
translate korean d21s02_arj_ending_db41a6ac:
    ...
    arj "내가 조사를 좀 했거든. 우리 주에는 여자 교도소가 딱 한 곳인 거 알고 있니?"
...
translate korean d21s02_arj_ending_6e8cf9e5:
    ...
    arj "이번 주말까지는 독방이든지 아니면 남자 교소도에 던져 지든지 하겠네."
...
translate korean d21s02_arj_ending_7e9a9a1c:
    ...
    arj "담배 반갑에 이리저리 팔리더라도 정신만 차리면 살 수는 있을 거야. 힘내."
...
translate korean d21s02_sy_ending_9767809c:
    ...
    sy "리디아, [mcname] 녀석이 없을 때 너랑 이야기하고 싶은 게 있었어."
...
translate korean d21s02_sy_ending_d84b7987:
    ...
    sy "내일 좋은 방법이 떠오를 수도 있어. 아니면 이십 년 뒤에 떠오를 수도 있고."
...
translate korean d21s02_sy_ending_6c2ffbee:
    ...
    sy "너랑 같이 감방을 쓰는 인간한테 뇌물을 줄 수도 있어. 아니면 교도관을 유혹해야 할 수도 있고."
...
translate korean d21s02_sy_ending_838bba9d:
    ...
    sy "넌 풀려날 수도 있겠지. 그리고 다른 나라에서 살면 된다고 생각할 거야."
...
translate korean d21s02_sy_ending_6d7f20f8:
    ...
    sy "그 날이 올 때까지, 넌 누구도 믿을 수도 없고, 누가 널 쫓는지도 모를 거고, 그 인간들한테 내가 무슨 짓을 하라고 했는지 알 수도 없을 거야."

# game/code/d21/d21s02.rpy:691
translate korean d21s02_sy_ending_98d09626:

    # sy "Sleep lightly."
    sy "너무 깊게 잠에 들진 말기 바라."
