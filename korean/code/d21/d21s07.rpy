...
translate korean d21s07_81f21ce2:
    ...
    "피고 측 변호사" "지금 말씀하는 사람이 [mcname] 영 맞습니까?"
...
translate korean d21s07_90cecf9a:
    ...
    lc "네, 저희는 같이 샤워를 하고 있었습니다. [mcname] 영은 저에게-"
...
translate korean d21s07_3c3adf41:
    ...
    mc "*속삭임* 리디아가 사실을 말하고 있다고 생각해 본 적은 없어? 자기 관점에서는 말이야."
...
translate korean d21s07_95880b2e:
    ...
    jdg "다시 한 번 이 법정에 정숙을 요구합니다. 재차 이런 요구는 하는 경우에는 법정 경위를 통해 해당 방청자를 퇴정시키겠습니다."
...
translate korean d21s07_0defe80f:
    ...
    jdg "그 자리에 계세요.{w} 검사, 증인에게 반대 심문을 하겠습니까?"
...
translate korean d21s07_c3045b05:
    ...
    "검사" "예, 존경하는 재판장님.{w} 칵스 씨, 당신은 스키너 씨의 행위에 대해 모르고 있었다고 증언했습니다."
...
translate korean d21s07_72931960:
    ...
    "검사" "제롬 스키너. 당신의 공동 피고인인 말입니다. 당신이 \"페티시 로케이터\"의 주모자라고 주장한 그 사람 말입니다."
...
translate korean d21s07_498a6091:
    ...
    lc "아, 알겠습니다. 그 사람은 제 알지도 못하고 동의하지도 않았는데 그 끔찍한 앱을 만들고 통제했습니다."
...
translate korean d21s07_250fb5b5:
    ...
    "검사" "그렇다면, 이전 증인이 증언한 바와 같이 해당 \"앱\"이 출시되기 한 학기 전 그 서버실의 접근 비밀번호를 확보하지 못했다는 겁니까?"

# game/code/d21/d21s07.rpy:132
translate korean d21s07_66da9489:

    # lc "I have no recollection of that."
    lc "그 점에 대해서는 기억나는 게 없습니다."
...
translate korean d21s07_13fd1863:
    ...
    "검사" "그리고 영 씨가 샤워 중에 당신에게 페티시 로케이터의 악행에 관해 말해 주었던 날...{w} 다른 증인이 증언 내용과 달리 당신은 해당 서버실에 있지 않았다 말입니까?"
...
translate korean d21s07_496a5ea5:
    ...
    "검사" "서버실이 조사관에 의해 봉쇄된 후 서버실에 들어가 증거를 없애려 하지 않았습니까?"
...
translate korean d21s07_a3ce6ce7:
    ...
    "검사" "조사관에 의해 해당 서버실의 관리 구획 전체에서 당신의 지문이 발견되었습니다. 이에 관해서 어떻게 설명하시겠습니까?"
...
translate korean d21s07_a7e25541:
    ...
    "피고 측 변호사" "이의 있습니다. 존경하는 재판장님! 피고 측은 해당 지문에 관해 어떠한 정보도 제공 받지 못했습니다."
...
translate korean d21s07_292b072f:
    ...
    jdg "지문 전문가 증언을 읽다가 잠이라도 잤습니까?{w} 기각합니다."
...
translate korean d21s07_b86dd748:
    ...
    lc "피트가 섹스하려고 절 거기로 데려갔어요. 전 그곳이 그 서비실인 줄은 몰랐어요."
...
translate korean d21s07_0d696740:
    ...
    "검사" "우리 모두 버틀러 씨의 연루 사실은 잘 인지하고 있습니가. 버틀러 씨는 유죄를 인정했고 당신 두 사람에 대해 불리한 증언을 했습니다."
...
translate korean d21s07_342c26e6:
    ...
    "검사" "그렇다고 해도 당신의 지문이 서버 관리자 키보드에서 발견된 이유는 설명되지 않습니다."
...
translate korean d21s07_60348f3d:
    ...
    lc "음...{w} 아! 우리는 같이 친밀한 시간을 보낼 때 영상을 보곤 해요. 아마 그래서 제 지문이 그 키보드에 묻었나 봐요."
...
translate korean d21s07_e4e44275:
    ...
    lc "저는 그 방에 갔습니다만, 그 시점은 [mcname] 군에게 해당 건에 관해서 이야기를 들은 다음이었습니다. 저는 페티시 로케이터를 폐쇄하려고 했던 거예요!"
...
translate korean d21s07_ab40b45f:
    ...
    "검사" "으흠. 본인 입으로 서버실에 가지 않았다고 말하지 않았던가요... 그 말이 거짓말이었던 겁니까, 아니면 지금 하는 말이 거짓말인 겁니까?"
...
translate korean d21s07_fc9885c8:
    ...
    "검사" "이 지문 증거가 있다는 사실을 몰랐다면 이 법정에서 계속 거짓말을 했겠군요?"
...
translate korean d21s07_186a6b02:
    ...
    "검사" "방금 발언은 철회하겠습니다. 더 이상 질문 없습니다."
...
translate korean d21s07_64862fc8:
    ...
    "피고 측 변호사" "하지 않겠습니다, 존경하는 재판장님.{w} 이 증인에 대한 추가 질문은 없습니다."
...
translate korean d21s07_27e3931c:
    ...
    jdg "증인석에서 내려와도 됩니다, 칵스 씨. 이 증인이 얼굴을 씻을 수 있는 곳으로 안내해 주겠습니까?"
...
translate korean d21s07_f479bbae:
    ...
    jdg "한 시간 동안 휴정한 후 최후 변론을 듣도록 하겠습니다."
...
translate korean d21s07_4b0b1950:
    ...
    mc "됐어, 판결이 너무 걱정돼. 리디아가 유죄가 아니면 좋겠어."
...
translate korean d21s07_bb0b652d:
    ...
    jdg "상황이 좀 달랐다면 매우 흥미로운 제안에 대해 이야기했을 텐데 아쉽군요."
...
translate korean d21s07_460c1cb2:
    ...
    jdg "개념은 유사하죠. 단, 노예 제도는 불법이고 부도덕하다는 점이 계약 노동과 다르죠."
...
translate korean d21s07_43f563bc:
    ...
    jdg "검사는 칵스 씨에게 개인 간수에 의한 가택 연금 형식으로 복역하라는 제안을 했습니다. 개인 간수는 칵스 씨의 처벌을 감독하게 됩니다."
...
translate korean d21s07_f87834b5:
    ...
    jdg "칵스 씨는 당신이 간수로 임명되는 경우에 한해 그 제안을 동의하겠다고 하더군요."
...
translate korean d21s07_1fe9fb92:
    ...
    jdg "그래요. 다만, 당신의 배경 조사 결과가 실망스럽더군요..."
...
translate korean d21s07_16a7213a:
    ...
    jdg "오히려 그 반대에요. 검사는 당신을 너무 착한 사람이라고 판단했으니까요."
...
translate korean d21s07_15e8bd3e:
    ...
    jdg "아무튼, 가도 좋습니다. 당신이 아주 아쉽게 기회를 놓쳤다는 점을 알려 주고 싶었을 뿐입니다."
...
translate korean d21s07_ffc2b8de:
    ...
    mc "판사님은 그저 제가... 놓친 기회에 대해 말씀해 주시려고 했다는 거군요. 제가 지금 그 기회를 다시 잡기 위해 할 수 있는 일은 아무것도 없지만 말이죠?"
...
translate korean d21s07_offer_19439a3e:
    ...
    "검사" "재판을 지켜보셨겠죠. 여자 친구 분의 재판이 어떻게 진행되고 있는지 어는 정도는 아실 겁니다."
...
translate korean d21s07_offer_b474956b:
    ...
    "검사" "이와 같은 경우는 매우 드뭅니다만, 검사 측은 두 형식을 조합하고자 합니다."
...
translate korean d21s07_offer_43bcb953:
    ...
    jdg "골자는 다음과 같아요. 리디아 칵스 씨의 자택을 개인 감옥으로 삼는다. 칵스 씨는 그 집에 가택 연금된다. 당신은 간수가 된다."
...
translate korean d21s07_offer_fcf9e8b2:
    ...
    "검사" "당신의 칵스 씨의 위법 행위로 고통 받은 피해자 중 한 사람입니다. 칵스 씨의 가택 연금을 집행할 간수로서 자격이 충분하죠."
...
translate korean d21s07_offer_434f4098:
    ...
    mc "그럼, 제가 리디아를 먹이고 주거지 안에만 있도록 책임져야 하나요?"
...
translate korean d21s07_offer_8f868d09:
    ...
    "검사" "*킬킬* 민영 교도소에서 재소자에게 음식이라고 주는 걸 보신 적이 있습니까? 원한다면 굶겨도 됩니다."
...
translate korean d21s07_offer_08d4aea5:
    ...
    jdg "전자 이식물이 있어요. 오래된 전자 발찌보다 훨씬 나은 물건이죠. 이걸 사용해서 칵스 씨를 주거지 안에만 머물도록 할 거예요."
...
translate korean d21s07_offer_465aab05:
    ...
    "검사" "칵스 씨는 수감 중 발생하는 모든 비용을 직접 지불해야 할 책임을 가집니다. 기본적으로 당해 당신은 그 집에 살면서, 간수로서 돈을 받고, 원하는대로 칵스 씨를 처벌하게 되는 겁니다."
...
translate korean d21s07_offer_2eabed2b:
    ...
    jdg "판결을 내리기 전까진 이에 대해선 말할 수 없어요. 게다가, 최후 변론을 듣지 못했는걸요."
...
translate korean d21s07_offer_abb437b5:
    ...
    "검사" "흠, 이 사건에는 세 가지 유형의 피해자가 있습니다."
...
translate korean d21s07_offer_f99cb58f:
    ...
    "검사" "일군의 피해자는 자신에게 일어난 일을 좋아합니다. 저로서는 용납할 수 없는 무리죠."
...
translate korean d21s07_offer_9cb76c2c:
    ...
    "검사" "*킬킬* 당연히 안 돼죠. 그렇지만 칵스 씨가 당신 대신 교도소를 고르진 않더군요."
...
translate korean d21s07_offer_d38b27dc:
    ...
    "검사" "칵스 씨는 이미 당신이 자신의 간수가 된다는 조건 하에 형량 거래 서류에 서명을 했습니다."
...
translate korean d21s07_offer_65520dd7:
    ...
    "검사" "칵스 씨는 자신이 당신을 조종할 수 있다고 믿는 모양이더군요. 하지만 저는 당신이 우위에 설 수 있다고 믿습니다."
...
translate korean d21s07_offer_7dd7007a:
    ...
    mc "리디아의 간수 역할을 하며 제 인생의 8년을 바치라는 말씀이세요?"
...
translate korean d21s07_offer_565af34a:
    ...
    "검사" "집세를 낼 필요도 없고, 돈도 받고, 할 수 있는 건 뭐든지 할 수 있는 일입니다."
...
translate korean d21s07_offer_d06d682c:
    ...
    jdg "물론, 6개월마다 건강 복지 검사를 받긴 해야 하지만, 일정은 편할대로 잡을 수 있죠."
...
translate korean d21s07_offer_6574713b:
    ...
    "검사" "여성 교도소는 흔치 않고, 있는 몇몇 교도소는 심각할 정도로 과밀한 상태입니다."
...
translate korean d21s07_offer_bdf485ad:
    ...
    "검사" "칵스 씨가 운이 좋아서 여성 교도소에 수감된다고 하더라도 문제죠. 일반동에서 내부자 거래부터 대량 살인으로 유죄를 선고 받은 사람들과 부대껴야 할 테니 말입니다."
...
translate korean d21s07_offer_1ba87b87:
    ...
    "검사" "그보다 운이 좋다면, 개방형 교도서의 여성동이나 혼성동에 수감될 겁니다."
...
translate korean d21s07_offer_c5dc7eee:
    ...
    "검사" "그렇다면야 옆에 살인자들이 있진 않겠지만, 칵스 씨처럼 예쁜 여자아이는... 뭐 당신도 어떻게 될지는 알겠죠."
...
translate korean d21s07_offer_95501597:
    ...
    jdg "검사님... 필, 서류 작업은 두고 자리 좀 비워 줘요. 이 청년과 이야기 하고 싶네요."
...
translate korean d21s07_offer_a5aa459f:
    ...
    jdg "법정 경위에 대해선 걱정하지 마. 저 사람들은 나에게 전적으로 충성하니까."
...
translate korean d21s07_offer_b3525b02:
    ...
    jdg "*킬킬* 내가 널 죽여도 개정 전에 네 몸뚱이랑 뒷처리도 다 해 줄 정도로 충성하지."
...
translate korean d21s07_offer_ee8076db:
    ...
    jdg "너무 긴장은 하지 마렴. 난 네가 알면 안 되는 사실을 말해 줄려고 이 자릴 만든 거니까."
...
translate korean d21s07_offer_da0fddc7:
    ...
    jdg "제롬은 쓰레기 같은 인간이지만, 네가 원한다면... 흠, 서류에 서명만 하렴."
...
translate korean d21s07_offer_72fe20c5:
    ...
    mc "제가 어떠한 처벌이라도 내릴 수 있다는 말씀이시라면..."
...
translate korean d21s07_jdg_quickie_c5fbdb59:
    ...
    jdg "생각해 본 적 있니? 내 재판을 받는 사람에 대해서 말이야?"
...
translate korean d21s07_jdg_quickie_0055fab5:
    ...
    jdg "피고인. 대부분은 재판에 들어가기도 전에 형량 거래를 위해 자백을 한단다. 하지만, 가끔은 이번처럼 진짜 사건이 들어오기도 하지."
...
translate korean d21s07_jdg_quickie_2a918e6d:
    ...
    jdg "피고인의 공포와 걱정에 대해서 생각해 봤니? 치안 판사의 손에 자기 운명이 달린 사람들의 심정을 말이야?"
...
translate korean d21s07_jdg_quickie_17264cfe:
    ...
    jdg "당연히, 난 내가 내린 형의 집행을 보지 못해. 공명정대해야 하니까."
...
translate korean d21s07_jdg_quickie_2a2cb083:
    ...
    jdg "하지만 가끔 늦은 밤이 되면 그 사람들에게 벌이 주어지는 순간을 상상하며 딸을 치지 않을 수가 없단다."
...
translate korean d21s07_jdg_quickie_650300ee:
    ...
    jdg "이리 오렴. 내 목구멍 깊숙이 네 자지를 쑤셔 넣어 줘."
...
translate korean d21s07_jdg_quickie_32193238:
    ...
    jdg "젠장. 왜 진작 이 멋진 남성성을 감탄하는 시간을 가지지 않았을까."
...
translate korean d21s07_jdg_quickie_2ddd50aa:
    ...
    jdg "인상적인야. 네 장엄한 자지에 따먹히려고 여자가 줄을 섰겠지."
...
translate korean d21s07_jdg_quickie_134ede17:
    ...
    mc "염병 이거지.{w} 이런 일이라면 하루 종일도 하겠는데."
...
translate korean d21s07_jdg_quickie_30f037c1:
    ...
    mct "어떻게 이런 대가리에 좆 박은 년이 판사가 된 거지?"
...
translate korean d21s07_offer_p2_bb95ae6d:
    ...
    jdg "곧 개정이군. 서류에 서명할 시간이 일이 분 정도는 남았겠네... 이 건은 네 마음대로 하렴."
...
translate korean d21s07_offer_p2_b2daac71:
    ...
    mc "거절할게요.{w} 하티건의 유명한 대사처럼, \"잘못된 일이 있고, 그릇된 일이 있으며, 나아가 *이런* 일마저 있다*\"."
...
translate korean d21s07_closing_875bd45e:
    ...
    "법정 경위" "모두 자리에 서십시오!{w} 리디아 칵스와 제롬 스키너 건에 대한 재판이 시작됩니다."
...
translate korean d21s07_closing_009a7012:
    ...
    jdg "리디아 칵스 씨, 내 앞에는 귀하의 탄원 양해에 동의하는 문서가 있습니다."
...
translate korean d21s07_closing_30410363:
    ...
    jdg "그렇습니다. [mcname] 영 씨는 8년이라는 기간 동안 당신의 처벌에 대한 책임을 받아들였습니다."
...
translate korean d21s07_closing_0265ba44:
    ...
    jdg "이 기간 동안 당신은 가택 연금 상태에 놓이게 되며, 영 씨의 적절하다고 판단하는 모든 처벌을 수행하고 감내해야 합니다."
...
translate korean d21s07_closing_89e6c1cb:
    ...
    jdg "당신은 사실상 중죄인으로서 일체의 권리가 박탈됩니다. 또한 [mcname] 영 씨를 당신의 주인으로 둔 계약 종업인이 됩니다."
...
translate korean d21s07_closing_3437dd76:
    ...
    "피고 측 변호사" "그렇습니다, 존경하는 재판장님. 칵스 씨의 서명은 이미-"
...
translate korean d21s07_closing_2b5605d7:
    ...
    jdg "닥치시오.{w} 당신이 칵스 씨의 변호인이나, 이 사안에 대해서는 칵스 씨에게 직접 들어야 합니다."
...
translate korean d21s07_closing_2f0f1d81:
    ...
    "검사" "감사합니다만, 이 건에 대해서는 형량 거래를 진행하지 않겠습니다. 이 사람은 종래의 교도소에 수감되는 편이 더 나은 선택이라고 생각합니다."
...
translate korean d21s07_closing_f2e63004:
    ...
    jdg "최종 변론을 들겠습니다. 검사 측, 먼저 진행하세요."
...
translate korean d21s07_closing_aac04d0f:
    ...
    jdg "어흠.{w} 피고인이 동료 배심원에 대한 권리를 포기했다는 사실을 인지하고 있습니까?"
...
translate korean d21s07_closing_d428027f:
    ...
    "검사" "그렇습니다, 알고 있습니다. 죄송합니다, 존경하는 재판장님. 습관 탓입니다."
...
translate korean d21s07_closing_00beb01d:
    ...
    hr "*속삭임* 닥치고 듣기나 해. 판사나 판결을 내리려고 한다고."
...
translate korean d21s07_closing_eb030173:
    ...
    jdg "리디아 칵스와 제롬 스키너 두 사람 모두 모든 혐의에 대해 유죄를 선고한다."
...
translate korean d21s07_closing_78d8a154:
    ...
    jdg "두 사람 모두 나이가 어리고 초범이라는 점을 참작한다."
...
translate korean d21s07_closing_24fc9002:
    ...
    jdg "2년 이하 형기에 대해 가석방을 받게 될 거예요. 가석방의 조건을 충족하는 경우, 복역하지 않아도 돼요."
...
translate korean d21s07_closing_2c90be27:
    ...
    jdg "가석방 조건을 준수하지 못하는 경우, 전체 형기를 복역해야 한답니다."
...
translate korean d21s07_closing_02d1a331:
    ...
    jdg "15년의 노역형을 선고한다. 당신의 항문에 신의 자비가 있기를."
...
translate korean d21s07_closing_3cd2cb39:
    ...
    mc "미안, 페티시 로케이터가 굴러가던 삼 주 동안 너무 흥분해서... 누구랑 떡쳤는지 누구랑 떡치지 않았는지 생각도 안나."
...
translate korean d21s07_closing_d6138452:
    ...
    hr "저 꼬인 썅년 때문에 그 모든 일이 생겼는데, 그냥 빠져나간다고?"
...
translate korean d21s07_closing_7800f73f:
    ...
    lc "*속삭임* 여기에 이렇게 사람이 많지 않았다면, 날 저 탁자 위에 던져 버린 다음 날 마음대로 하라고 했을 거야."
...
translate korean d21s07_closing_dc6d9ee1:
    ...
    lc "청혼해 줘. 그럼, \"응\"이라고 답할게. 바로 할 수 있어."
...
translate korean d21s07_closing_93c29f66:
    ...
    lc "결혼이 싫다는 게 아냐, 바보야. 물론 난 너랑 결혼할 거야. 난 지금 세상에서 가장 행복한 여자인걸!"
...
translate korean d21s07_closing_bccceea6:
    ...
    lc "여기서 당장 결혼하고 싶지는 않아. 혼인 신고서도 없잖아."
...
translate korean d21s07_breakup_6b6dc6f1:
    ...
    mc "자기야, 정말 이 순간을 망치고 싶지는 않아, 그런데-"
...
translate korean d21s07_breakup_d6d51910:
    ...
    mc "그러니까, 난 우리가 계속 친구 사이면 좋겠어... 우리가 즐거운 땐 언제나 곁에 있어 줄 수 있다는 거 알잖아."
...
translate korean d21s07_breakup_71168c22:
    ...
    lc "딱 티나더라. 같이 구류장에 찾아온 다음부터 왠지 이렇게 될 거라는 생각이 들기도 했구."
...
translate korean d21s07_breakup_747f0a0e:
    ...
    lc "말로 하는 게 쉽지는 않았을 텐데, 이렇게 말해 줘서 정말 고마워."
...
translate korean d21s07_breakup_1213baad:
    ...
    lc "나도 그래. 넌 지금도 그렇고 앞으로도 그렇고, 내 친구야. 내가 좋아하는 사람 중 하나야."
...
translate korean strings:
    ...
    new "앰로즈를 위해 리디아를 온화하게 거절한다"

    # game/code/d21/d21s07.rpy:918
    old "Let Lydia Down Gently for Stacy"
    new "스테이시를 위해 리디아를 온화하게 거절한다"
