...
translate korean d21s04_68d7354d:
    ...
    mc "나도 내가 바보 같다는 거 알아. 그치만 난 리디아를 아꼈어. 그 모든 일이 있었고, 그 뒤에 리디아가 있었지. 그치만 난 아직도 리디아한테 마음이 있어."
...
translate korean d21s04_4faf00f1:
    ...
    mc "나도 모르겠어. 난 리디아를 아꼈지. 그런데 지금은? 리디아를 생각할 때마다 만감이 교차해."
...
translate korean d21s04_b070631d:
    ...
    mc "변호사께서 의뢰인에게 이런 부탁을 하는 건 좀 부적절하지 않나요?"
...
translate korean d21s04_9bfc4d0e:
    ...
    mh "좋아. 내가 좋은 아시아 음식점을 알아. 그 집 매콤한 돈까스가 당신을 한 방에 처리해 줄 거야."
...
translate korean d21s04_b77e22dd:
    ...
    mc "아, 이런. 비극적인 배신을 이겨낼 땐 마음까지 마비시킬 정도로 매콤한 음식만큼 좋은 것도 없지."
...
translate korean d21s04_5acc6226:
    ...
    mc "그치만 재미있는걸! 리사가 작고 귀여운 다람쥐처럼 보인다구."
...
translate korean d21s04_13b2bd0e:
    ...
    mh "알겠어. 당신이 {i}예의 없이{/i} 날 방해하기 전에 하던 말을 계속할게."
...
translate korean d21s04_53bea87a:
    ...
    mh "당신도 알고 있겠지만, 난 앨리슨 외에는 사귀었던 사람이 그리 많지 않아."
...
translate korean d21s04_e97ef901:
    ...
    mh "*웃음* 진심으로 말하자면, 우리에게 정작 중요한 건 외롭기 싫다는 바람이었다고 생각해."
...
translate korean d21s04_86a35ae9:
    ...
    mh "우린 대부분은 공부에 열중했어. 그렇게 일종의... 동지애를 쌓았지."
...
translate korean d21s04_9a4d00c7:
    ...
    mh "당신 말대로야. 우리 중 몇몇은 서로를 위해 언제든 곁에 있었어. 감정적으로든, 그리고 때로 신체적으로든."
...
translate korean d21s04_cefe8c51:
    ...
    mc "그럼 기숙사에선 온갖 변태 짓이란 짓은 다 했겠구만?"
...
translate korean d21s04_fc4ea962:
    ...
    mc "오줌 기벽이 있는 여성 분께서 그런 과거가 있었다니?"
...
translate korean d21s04_8b3f2d0a:
    ...
    mc "*킬킬* 그럼 리사의 기벽은 {i}뭔데{/i}? 우리 이런 얘긴 한 번도 안 했잖아."
...
translate korean d21s04_896b2eee:
    ...
    mh "당신도 이미... 내가 특정 {i}수상 경기{/i}에 관심이 있다는 사실은 알 테고."
...
translate korean d21s04_e1d36910:
    ...
    mh "외에는, 침대에선 복종적인 역할을 하는 것도 좋아해. 그렇지만 나는 내가 지배적인 역할이든 복종적인 역할이든 모두 할 수 있다고 생각해."
...
translate korean d21s04_d97d3dbb:
    ...
    mh "음, 난 보통 침대에선 복종적인 역할을 하는 걸 좋아하지만, 나는 내가 지배적인 역할이든 복종적인 역할이든 모두 할 수 있다고 생각해."
...
translate korean d21s04_24d02941:
    ...
    mh "우리가 처음 만났을 때 당신이 이런 유형의 관계는 처음이라고 분명히 했는걸."
...
translate korean d21s04_c5edd37c:
    ...
    mh "어떤 일도 조급히 밀어붙이고 싶지 않았어. 당신에게 상처를 줄 수도 있으니까."
...
translate korean d21s04_464bae19:
    ...
    mh "그리고 서두르지 않아도 당신과 내가 함께한 시간은 {i}충분히{/i} 즐거웠는걸."
...
translate korean d21s04_d8d3a61e:
    ...
    mh "그 외에는 나한테 \"심각한\" 기벽 같은 건 없어. 그래도 난 어떠한 일에도 열려 있지만."
...
translate korean d21s04_95ded377:
    ...
    mc "내가 {i}진짜 세상을 보여 주었다{/i}고 말하고 싶은 거구나?"
...
translate korean d21s04_162370d7:
    ...
    mh "*빙그레* 의뢰인들을 변호해 왔던 경험도 이 말을 하는 데는 도움이 되지 않네."
...
translate korean d21s04_aad568f7:
    ...
    mh "난 당신을 사랑해, [mcname]. 그래서 당신과 내가 진지한 관계를 맺길 바라."
...
translate korean d21s04_7e5df79a:
    ...
    mh "이런 말을 하지만 불안하고 두려워. 이건 쉽지 않은 약속이니까. 난 당신이 이 관계를 정말 바라는지 모르니까."
...
translate korean d21s04_ebd5fb90:
    ...
    mh "그리고 당신뿐만이 아니야. 스테이시도 많이 생각해 왔어."
...
translate korean d21s04_f410ec84:
    ...
    mh "응. 우리가 만난 건 손에 꼽을 정도라는 점은 알지만, 스테이시도 나에게 정말 소중한 사람이 되었어."
...
translate korean d21s04_352ba3d0:
    ...
    mc "*킬킬* 리사한테 그 말을 직접 들었으면 기뻐서 기절을 하겠는데."
...
translate korean d21s04_50a11e79:
    ...
    mh "그리고 당신뿐만이 아니야. 올리버도 많이 생각해 왔어."
...
translate korean d21s04_f0aaa26e:
    ...
    mc "리사. 나도 너와 함께하고 싶어. 그리고 올리버와 함께 우리가 어떤 삶을 살아가게 될지 알고 싶어."
...
translate korean d21s04_3b978387:
    ...
    mc "오래동안 알아 온 사이가 아니라는 건 알아. 그래도 그러고 싶어. 그건 확실해."
...
translate korean d21s04_1f80d236:
    ...
    mc "그리고 나도 네가 듣고 싶어하는 답을 바로 해 주고 싶어. 하지만 결정을 내리기 전에 생각할 시간이 필요해."
...
translate korean d21s04_3913f7ac:
    ...
    mh "당신이 어떤 선택을 하든, 난 당신이 나에게 선사해 준 모든 일에 감사하고, 항상 우리가 함께한 시간을 소중하게 기억할 거야."
...
translate korean strings:
    ...
    new "리사 그리고 스테이시와 함께하고 싶다"

    # game/code/d21/d21s04.rpy:389
    old "I want to be with you and Oliver"
    new "리사 그리고 올리버와 함께하고 싶다"
