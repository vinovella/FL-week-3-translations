...
translate korean d21s06_a1ce140a:
    ...
    arj "그래서 다섯 명이랑 해 본 적은 정확히 몇 번이나 해 봤는데?"
...
translate korean d21s06_7b95aa66:
    ...
    arj "기억이 안 난다라. 귀하, [mcname], 본인께서 오인조 활동의 일원으로 참여했는지도 기억을 못한다는 말씀이시군요."
...
translate korean d21s06_e05431c2:
    ...
    arj "이 멋진 녀석이 금붕어급 기억력을 가지고 있다는 문제가 있어서."
...
translate korean d21s06_d0eccf61:
    ...
    sy "그러니까, 온다는 건 알고 있었고, 나는 샤워해야 했으니까. 그러니까 열어 뒀지. 아까 전화할 때 말했잖아."
...
translate korean d21s06_029a00d1:
    ...
    mc "네가 괜찮으면, 나도 괜찮아. 내 물건만 챙겨 오면 되겠네."
...
translate korean d21s06_fd626a1c:
    ...
    sy "요 며칠 새 돈벼락이라도 맞았냐? 몇 년 만에 신용 등급이 오르기라도 했어?"
...
translate korean d21s06_a331213d:
    ...
    mc "다섯이서 한 다음엔 옷 제대로 입는 것도 힘들다니까."
...
translate korean d21s06_1575df4e:
    ...
    mc "그러면 다른 사람 다 입는 옷을 입는 우린 무슨 사회 계층에 포함되는 건데?"
...
translate korean d21s06_032e8e68:
    ...
    sy "야, 그렇게 해서 나도 벗게 만들 생각이면, 문제 생긴다고 말해 줄게."
...
translate korean d21s06_50a02fb7:
    ...
    sy "플레이보이는 개뿔, 배드보이지! 넌 그렇게 보고도 더 볼 포르노가 남았냐!"
...
translate korean d21s06_aef15cc3:
    ...
    mc "솔직히 난 이걸 우리가 어떻게 조립했는지 기억도 안 나는데."
...
translate korean d21s06_90dd921c:
    ...
    sy "나도 그 생각해 봤는데, 창고는 좀 비싸더라. 난 창고 임대료까지 낼 형편이 못된다구."
...
translate korean d21s06_3adb97ac:
    ...
    mc "내가 아는 사람 중에 창고를 전대해 줄 만한 사람이 있어. 근데 이 단어 이럴 때 쓰는 거 맞지?"
...
translate korean d21s06_58740b22:
    ...
    arj "스테이시, 그런데 패러데이 상자는 왜 보관하려는 거야? 이제 페티시 로케이터 서버도 내렸으니, 쓸모도 없잖아."
...
translate korean d21s06_6c84a96d:
    ...
    sy "우리가 페티시 로케이터 계획을 재기동한다면 이게 필요할 테니까."
...
translate korean d21s06_86823ceb:
    ...
    arj "페티시 로케이터를 박살 내겠다고 우리가 그 온갖 짓을 다 해서 여기까지 왔는데, 네가 원하는 건 그걸 다시 시작하는 거라고?"
...
translate korean d21s06_642d32cf:
    ...
    arj "이건 그냥 걱정이라고 넘어갈 일이 아냐. 페티시 로케이터는 많은 사람을 절망에 빠트렸어. 그렇게 걱정하는 점 안다고 넘어갈 일이 아냐."

# game/code/d21/d21s06.rpy:335
translate korean d21s06_a73fc0aa:

    # sy "And I'm here to address them."
    sy "그래서 내가 그 점을 고치려는 거야."
...
translate korean d21s06_4d3bdad2:
    ...
    sy "있잖아, 만약에 우리가 믿을 수 있는 사람만, 정말로 믿을 수 있는 사람 하고만..."
...
translate korean d21s06_514a6eaa:
    ...
    arj "좋아, 피트, 리디아, 그리고 교수님들도 다 초대해서, 우리 앞길에 꽃이라도 뿌려 달라고 할까?"
...
translate korean d21s06_ab941435:
    ...
    mc "민이랑 같이 휴양 온천 호텔을 만들자는 이야길 했었어. 자세히 말할 만할 정도는 아니야."
...
translate korean d21s06_b1e7182a:
    ...
    mc "페티시 로케이터 건은 그만해. 앰로즈가 절대로 안 내켜할 거야."
...
translate korean d21s06_2561a9f8:
    ...
    sy "우리가 되게 만들면 돼. 넌 뭐가 걸려서 그런데? 우리는 사람을 밀어낼 게 아니라, 끌어들어야 해. 앰로즈는 그냥 가게 두기엔 너무 소중하다구."
...
translate korean d21s06_e4065b21:
    ...
    mc "우리 계획을 생각할 시간은 충분해. 지금은 잠시 미루어 두자. 알겠지?"
...
translate korean d21s06_29cc06d2:
    ...
    sy "아니, 다른 이야길 하려고 했는데... 그건 나중에 얘기해도 될 거 같아."
...
translate korean d21s06_8c4e591b:
    ...
    mc "나중에 이야기하자. 재판 끝난 다음에. 꼭 그렇게 할게, 스테이시."
...
translate korean d21s06_22e45b3b:
    ...
    arj "난 스테이시가 페티시 로케이터 재시동 계획에 대해 일장 연설하는 거 듣고 싶지 않아."
...
translate korean d21s06_24746985:
    ...
    sy "장점, 우리는 선한 목적을 위해, 즉 사용자의 이익을 위해 소프트웨어를 사용한다."
...
translate korean d21s06_0af59612:
    ...
    arj "단점, 모든 소프트웨어 개발자는 앞에선 번지르르한 약속을 하고 뒤론 다른 짓을 한다."
...
translate korean d21s06_1954fefa:
    ...
    sy "우리는 자체 서버실을 갖는다? [mcname], 지금 좀 도와줘야지!"
...
translate korean d21s06_9347c6b3:
    ...
    arj "단점, 서버실은 어디에 두려고? 그리고 서버가 얼마나 비싼 줄 아니? 게다가 서버 유지는 엄청 번거로울 거야."
...
translate korean d21s06_50968dbb:
    ...
    arj "데이터가 유출되면 어쩔 건데? 그리고 해커가 서버 상의 데이터를 훔치면 어쩔거구?"
...
translate korean d21s06_51f9b7a4:
    ...
    arj "내가 어떻게 안 그럴 수가 있겠니? 넌 우리가 여기에 모인 이유도, 이 상자를 해체하는 걸 도운 이유도 다 잊은 것처럼 구는구나."
...
translate korean d21s06_3f2b16a1:
    ...
    arj "우리는 패러데이 상자를 보관하기 위해서 온 게 아냐, 없애려고 온 거지."
...
translate korean d21s06_af198695:
    ...
    sy "나도 알아. 어젯밤엔 이 문제 때문에 잠을 잘 수가 없었어."
...
translate korean d21s06_7f08d97b:
    ...
    sy "물론 그냥 없앨 수도 있어. 하지만 우리에겐 기반도 있고, 경험도 있어. 그런데 왜 이걸로 아무것도 안 하려는 거야?"
...
translate korean d21s06_97c9eeec:
    ...
    sy "왜 그냥 다 없애 버리고 재수 없던 일이었다고 끝내 버리려는건데?"
...
translate korean d21s06_84a6fd86:
    ...
    arj "달라, 그런 관계를 갖기로 결정한 건 나였으니까. 하지만 페티시 로케이터 때문에 일어났던 일엔 난 동의한 적 없었어."
...
translate korean d21s06_3d78d5f9:
    ...
    arj "그런 관계를 갖기로 결정한 건 나였으니까. 그리고 그래서 정말 행복해. 하지만 페티시 로케이터와 엮였던 일 전부 후회해."
...
translate korean d21s06_0b860f44:
    ...
    arj "아니, 있어. 너도 들어야 하니까. 난 페티시 로케이터에 엮기고 싶지 않아."
...
translate korean d21s06_278cd250:
    ...
    mc "너희 둘이서 이야기해도 충분하다고 생각했는데. 내가 보탤 말도 없던걸. 너는 페티시 로케이터로 뭐라도 하고 싶다는 거구나."
...
translate korean d21s06_ab888f37:
    ...
    sy "응, 우리 동료가 되는 거야, 사업 동료가 되서, 제대로 된 페티시 로케이터를 만들고 시장에 선보이고 싶어."
...
translate korean d21s06_50ef34a5:
    ...
    sy "우리가 몸소 체험하고 본 바와 같이, 엄청난 수요가 있으니까."
...
translate korean d21s06_f873f48c:
    ...
    sy "앱을 우리가 허용한 사람들만 이용할 수 있게 만들고 당장은 초대제로 운영하는 거야. 그렇게 해서 우리가 하고 싶은 게 맞다 싶으면 공개하는 거지."
...
translate korean d21s06_c2c04551:
    ...
    sy "앰로즈가 이 건에 대해서 어떻게 생각하는진 알겠어. 그런데 넌 이 계획에 관심 있는 거야, [mcname]?"
...
translate korean d21s06_reboot_fl_77580ab7:
    ...
    arj "난 여기 한 가지 일을 하러 왔어. 그리고 그런 일처럼 번잡한 일엔 정말 관심 없어."
...
translate korean d21s06_reboot_fl_0866133d:
    ...
    arj "설계 자체가 비윤리적인 제품을 윤리적으로 만들기는 어려운 일이야."
...
translate korean d21s06_reboot_fl_3041e296:
    ...
    sy "[mcname]한테 경영 관리를 맡길 거야. 경영학에서 경영 윤리 같은 것도 가르치잖아."
...
translate korean d21s06_reboot_fl_aebbd3e6:
    ...
    mc "경영 윤리는 존재해. 자주 적용되지 않긴 하지만 말이야. 확신이 안 서는가 보구나."
...
translate korean d21s06_reboot_fl_ec7b26e1:
    ...
    arj "그래. 만약에, 그러니까, 어, 뭐라고 하지, 사용자를 감시하는 앱이라면, '싫어, 그렇게 하지 마'라고 말할 수 있는 권한을 원해."
...
translate korean d21s06_reboot_fl_07f2a176:
    ...
    arj "그렇게 말할 수도 있겠지, 좋아. 내가 대통령 같은 역할을 할게."
...
translate korean d21s06_reboot_fl_6b681469:
    ...
    sy "으으음. 알겠어. 그러면 윤리적인 문제에 관한 건은 너한테 보여 주란 말이지."
...
translate korean d21s06_reboot_fl_c4f0491c:
    ...
    sy "그래, 그렇게 하자. 그게 원하는 바라면, 이런 문제에 대한 최종 결정권은 네가 행사해."
...
translate korean d21s06_reboot_fl_ebf0195d:
    ...
    mc "앰로즈, 부담 가질 필요 없어. 내키지 않은 일은 하지 마."
...
translate korean d21s06_reboot_fl_604f260e:
    ...
    arj "내가 의사 결정에 적극적으로 참여할 수 있고 최종 결정권을 가진다는 거지?"
...
translate korean d21s06_reboot_fl_e3616b15:
    ...
    arj "그런데, 한 가지 문제가 더 남았어. 이건 진지한 문제야."
...
translate korean d21s06_reboot_fl_d3a6634e:
    ...
    mc "그건 우리 모두 약속할게, 앰로즈. 우리는 네 신념에 절대 반하지 않을 거야. 맹세해."
...
translate korean d21s06_reboot_fl_5b792732:
    ...
    sy "만약에 우리가 어떤 결정을 내렸는데, 그게 윤리적으로... 싫다면, 그러니까 내 말은, 넌 언제든지 우리한테 말할 수 있고 우리는 경청할게."
...
translate korean d21s06_reboot_fl_020364b4:
    ...
    sy "우린 정말 제대로 하고 싶어, 그래서 네가 없으면 안 돼. 그리고 이상한 코더 중도 참여시키지 않을게."
...
translate korean d21s06_reboot_fl_8db8be57:
    ...
    arj "그 전에, 전화 한 통 할게. 복도에서 몇 분이면 될 거야."
...
translate korean d21s06_no_fl_df8bb7ca:
    ...
    sy "너희들이 계획을 듣기도 싫어한다는 건 알겠어. 그치만 나한테 일 분만 줘 봐. 왜 이게 좋은 계획인지 설명할게."
...
translate korean d21s06_no_fl_18d641b9:
    ...
    arj "보통은 이렇게까진 안 하는데, 이 건에 관해서는 이미 마음을 정했어, 미안."
...
translate korean d21s06_no_fl_ad3129e2:
    ...
    arj "난 페티시 로케이터에 관련된 건 전혀 관심 없어, 예전 거든 새로운 거든."
...
translate korean d21s06_no_fl_749133d1:
    ...
    arj "그 잠깐이 일 분이라면 시간 돼. 몇 분 정도 여유 있어."
...
translate korean d21s06_no_fl_944d2c89:
    ...
    mc "음, 그 정도에 다 설명하기엔 불가능한데. 사업 제안이 있거든."
...
translate korean d21s06_no_fl_96194d39:
    ...
    arj "실은, 토지 임대에 관해서 이야기할 사람이 있어서 가려던 참이었어."
...
translate korean d21s06_no_fl_659de358:
    ...
    sy "그래서 휴양 온천 호텔을 차리는 것보다 더 좋은 생각이야?"
...
translate korean d21s06_no_fl_15fb4eb7:
    ...
    arj "그 생각은 제대로 못 들었는데. 아무튼, 일 분 지났어, 나 가야 돼. 안 그럼 기차 놓쳐."
...
translate korean d21s06_no_fl_549a25f5:
    ...
    sy "좋아, 음. 패러데이 상자 부품을 경매에 부쳐 보실까."
...
translate korean d21s06_no_fl_d839bd45:
    ...
    sy "너 완전 감이 죽었구나, 아냐? 수요가 아주 많걸랑. 자, 항목이나 등록하자. 4x4 부품에 천 달러. 꽤 괜찮네."
...
translate korean d21s06_waterfall_bdfe5f3f:
    ...
    mc "있잖아, 워터스포츠 사업 건 때문에 연락했는데, 시간 돼?"
...
translate korean d21s06_waterfall_ba428702:
    ...
    sy "안녕, 민! 나 지금 [mcname] 그리고 앰로즈랑 같이 있어!"
...
translate korean d21s06_waterfall_7d45ad20:
    ...
    mc "그래서 생각을 해 보니까. 사람들이 워터스초프를 연습할 만한 공간이 부족하다는 생각이 들었어."
...
translate korean d21s06_waterfall_88555c8d:
    ...
    arj "그래. 일 분 이상이긴 했지만, 흥미롭긴... 구미가 돋던걸. 이제 난 가야 돼."
...
translate korean d21s06_waterfall_d9ec8d68:
    ...
    mc "있잖아, 이거 좋은 생각인데. 패러데이 상자 부품를 운반하고 옮기는 회사."
...
translate korean d21s06_waterfall_f3e95fbb:
    ...
    mc "특허 등록을 하려면 서류를 내야 하거든요, 그냥 말만으론 자기 특허라고 주장 못한답니다."
...
translate korean d21s06_waterfall_f01db528:
    ...
    sy "술 마시러 갈래? 아님 그냥 여기서 비디오 게임이나 할까?"
...
translate korean d21s06_wellness_spa_2b0a85bf:
    ...
    mes "하지만 이면을 아는 사람한테는 원할 때까지 특별한 용역을 제공할 거야."
...
translate korean d21s06_wellness_spa_ff415117:
    ...
    mes "그리고 사업은 온천 호텔, 워터스포츠, 휴식, 휴양의 전문가의 기준에 맞추어 운영할 거야."
...
translate korean strings:
    ...
    new "관심 있다. 나는 페티시 로케이터를 재시동해 보고 싶다"
