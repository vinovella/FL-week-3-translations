...
translate russian e10s03_9bb71d64:
    ...
    mc "*свистит* Черт. Это квартира класса люкс."
...
translate russian e10s03_c8087d18:
    ...
    mes "Кто знает? Моего отца не волнуют деньги."
...
translate russian e10s03_7cf18945:
    ...
    mes "{i}Дочери \"выдающегося генерального директора\" нужна подобающая гламурная квартира.{/i}"
...
translate russian e10s03_25392970:
    ...
    mc "Черт возьми, я бы хотел, чтобы меня контролировали вот {i}так{/i}."
...
translate russian e10s03_93255d37:
    ...
    mc "Я бы хотел, чтобы ты могла делать всё, что хочешь. Но я понимаю, какие обязательства у тебя есть перед своей семьей."
...
translate russian e10s03_24095088:
    ...
    mc "Я нахожусь в удивительной стране, где так много всего интересного и познавательного, и я здесь со своей прекрасной девушкой."

# game/code/e10/e10s03.rpy:78
translate russian e10s03_2a7effc2:

    # mc "What more could I ask for?"
    mc "О чем еще можно мечтать?"
...
translate russian e10s03_232ca5cc:
    ...
    mc "А теперь, как ты смотришь на то, если мы найдем применение этому удобному дивану?"
...
translate russian e10s03_b11f5511:
    ...
    mes "Нет. Не сейчас. Я только что её погладила. Не хочу, чтобы она помялась."
...
translate russian e10s03_c9ca8a39:
    ...
    mes "Просто... *вздох* Извини. Просто я слишком напряжена. И я хочу хорошо выглядеть в свой первый день."

# game/code/e10/e10s03.rpy:127
translate russian e10s03_ce877b52:

    # mc "Hey. I understand. It's okay."
    mc "Эй. Я понимаю. Все в порядке."
...
translate russian e10s03_73bdd3cc:
    ...
    mc "Проклятье. Что они заставили тебя делать? Каторжный труд?"
...
translate russian e10s03_e56a89b9:
    ...
    mc "*смеется* Я уверен, что все наладится, как только ты войдешь в ритм."
...
translate russian e10s03_d472ee2d:
    ...
    mes "Нет, все в порядке. Я уже поужинала с папой и некоторыми членами совета директоров."
...
translate russian e10s03_674174cb:
    ...
    mct "Тогда я просто разогрею что-нибудь для себя."
...
translate russian e10s03_motage_end_087444d0:
    ...
    mc "Из этого существования, где мы безучастно наблюдаем, как жизнь утекает. От этой жизни, в которой мы почти не касаемся друг друга."
...
translate russian e10s03_motage_end_e6161be7:
    ...
    mc "Воплощая твою мечту в жизнь!"
...
translate russian e10s03_motage_end_150bb079:
    ...
    mc "Мин, я буду честен. Мне было до смерти скучно сидеть здесь, одному, без тебя."
...
translate russian e10s03_motage_end_5577e409:
    ...
    mc "Не говоря уже о том, чтобы видеть, как ты устаешь, работая на такой работе."
...
translate russian e10s03_motage_end_26273f8d:
    ...
    mc "Поэтому я решил взять дело в свои руки."
...
translate russian e10s03_motage_end_74d8fedb:
    ...
    mc "Если у меня и было что-то в избытке, так это время, поэтому я использовал это время, чтобы исследовать и узнать больше о ВТСИАН - хотя у меня не было времени, чтобы придумать для нее хорошее название."
...
translate russian e10s03_motage_end_c41ffd82:
    ...
    mc "В любом случае. Я знаю, что это то, чем ты хочешь заниматься, и после изучения этого вопроса, я нахожу его действительно интересным!"
...
translate russian e10s03_motage_end_2a3fdf7e:
    ...
    mc "И тогда мне пришла в голову идея. Почему бы нам не создать компанию, которая специализируется на этом?"
...
translate russian e10s03_motage_end_dc07fc89:
    ...
    mc "С твоими знаниями и моей деловой хваткой у нас все получится!"
...
translate russian e10s03_motage_end_367b87e2:
    ...
    mc "Я знал, что ты так скажешь. И поэтому ты будешь помогать мне только тогда, когда сможешь."
...
translate russian e10s03_motage_end_d5e6b4fc:
    ...
    mc "А {i}я{/i} позабочусь обо всем остальном. У меня уже есть солидный бизнес-план."
...
translate russian e10s03_motage_end_b27675ec:
    ...
    mc "Мин, я знаю, что ты тоже не удовлетворена этой жизнью. Ты можешь сделать гораздо больше. {i}Достичь{/i} гораздо большего."
...
translate russian e10s03_motage_end_80447ba0:
    ...
    mc "Но я знаю, что ты не можешь делать это, одновременно работая в компании своего отца. {w}Так что позволь мне {i}помочь{/i}. {w}Вместе мы сможем это сделать."
...
translate russian e10s03_motage_end_0bdb2bde:
    ...
    mc "Хорошо, садись поудобнее, потому что это надолго."
