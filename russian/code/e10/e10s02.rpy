...
translate russian e10s02_59d38164:
    ...
    mes "Он представится сам, но можешь называть его До-юн."
...
translate russian e10s02_b93746e9:
    ...
    mes "Нет. Правильно Мин До-юн. Мы ставим фамилию перед именем."

# game/code/e10/e10s02.rpy:56
translate russian e10s02_57572cdb:

    # mc "Right, sorry. Anything else I should know?"
    mc "Конечно, извини. Что-нибудь еще мне нужно знать?"
...
translate russian e10s02_3fc86124:
    ...
    mes "Знаешь, просто постарайся не открывать рот лишний раз. Будь почтителен. Не ставь в неловкое положение ни себя, ни меня."

# game/code/e10/e10s02.rpy:63
translate russian e10s02_06eb03ff:

    # mc "I'll do my best."
    mc "Я сделаю все, что в моих силах."
...
translate russian e10s02_4c61156c:
    ...
    mct "Что мне делать? Я должен поклониться? Или что-то сказать? {w}Дерьмо. Я не готов к этому."
...
translate russian e10s02_59b814d1:
    ...
    mc "Здравствуйте. Меня зовут [mcname] Янг. {w}Или, если по вашему, Янг [mcname]."

# game/code/e10/e10s02.rpy:90
translate russian e10s02_15fd73fd:

    # md "{i}*speaks in a language you don't understand*{/i}"
    md "{i}*говорит на языке, которого вы не понимаете*{/i}"
...
translate russian e10s02_b82a39a2:
    ...
    mes "Нет, папа. Это был мой бывший парень. Он... {w}проявил ко мне неуважение. Сейчас я с [mcname]ом."

# game/code/e10/e10s02.rpy:96
translate russian e10s02_93eef468:

    # mc "This is a power play."
    mc "Это демонстративное поведение."
...
translate russian e10s02_bed64e5e:
    ...
    mc "... С вашей дочерью. Вы знаете, кто я такой. И вы упоминаете ее бывшего парня, чтобы продемонстрировать свою власть."
...
translate russian e10s02_91ba1686:
    ...
    md "*смеется* Неплохо, [mcname]. Возможно, ты не совсем бесполезен."
...
translate russian e10s02_86a5e4c2:
    ...
    mm "Рада с тобой познакомиться, [mcname]. Наша дочь высоко отзывалась о тебе."
...
translate russian e10s02_a44b1991:
    ...
    md "Не нужно выходить за рамки формальности."
...
translate russian e10s02_fb405b1e:
    ...
    mb "Расслабься, папа. Это не деловая встреча. Это светское мероприятие."
...
translate russian e10s02_3400e76f:
    ...
    mb "Во время социальных взаимодействий оптимально будет ослабить правила и плыть по течению."

# game/code/e10/e10s02.rpy:142
translate russian e10s02_18e08b6b:

    # md "I suppose you are right, but it does not sit well with me."
    md "Полагаю, ты прав, но мне это не нравится."
...
translate russian e10s02_2a063180:
    ...
    mc "Спасибо. Я согласен с До-юн, эм... Доном? {w}Меня тоже не устраивает формальность..."
...
translate russian e10s02_506d30e3:
    ...
    mes "Я уверена, что со временем [mcname] научится - и что он произведет на тебя впечатление, папа."
...
translate russian e10s02_be8b63f7:
    ...
    mc "Эм, вообще-то я никогда не следил за бейсболом... {w}Я мог бы рассказать о футболе, но у нас ещё несколько месяцев до начала сезона."
...
translate russian e10s02_73b9b8d0:
    ...
    mm "Я всегда была фанаткой Тигров."
...
translate russian e10s02_b54ac9de:
    ...
    mc "Детройтские Тигры? Да, слышал о них. \"Вперед, Львы, и заберите с собой Тигров.\""
...
translate russian e10s02_f1aa3ea1:
    ...
    mb "Извини, но нет. Мать имеет в виду Тигров Хансина. Она помешана на Японии."
...
translate russian e10s02_0ae4d833:
    ...
    mct "Ох, черт возьми, кажется меня ждет длинная история о рождении Брюса..."

# game/code/e10/e10s02.rpy:184
translate russian e10s02_dc7d891d:

    # md "If I may interrupt to discuss business."
    md "Если позволите, я поговорю с дочерью, нам нужно обсудить кое-какие дела."
...
translate russian e10s02_5c4c774b:
    ...
    md "Дочь, ты пойдешь работать в штаб-квартиру? У нас есть вакансия, которую ты должна занять."
...
translate russian e10s02_7616c38f:
    ...
    mes "Конечно, папа. Летняя стажировка начинается через пару недель, так что..."
...
translate russian e10s02_d739aa85:
    ...
    md "Не в этот раз. {w}Я знаю, что ты готова к большему..."
...
translate russian e10s02_2aa454af:
    ...
    md "Мы обсудили это и решили, что ты готова к реальной должности. Ты можешь приступать завтра."
...
translate russian e10s02_a083872c:
    ...
    mes "Что? Мне продолжить свое образование где-нибудь в другом месте?"
...
translate russian e10s02_8b451d52:
    ...
    mb "Мы с отцом уже обсуждали это. Конечно, ты можешь вернуться осенью, но ты явно готова приступить к работе."
...
translate russian e10s02_e0a2027c:
    ...
    mb "Здесь нечего раздумывать. Это потрясающая возможность."
...
translate russian e10s02_5476e36c:
    ...
    mc "Она говорила, что хочет заняться кое-чем другим."
...
translate russian e10s02_d9557a4f:
    ...
    mc "Вам не приходило в голову спросить ее о ее планах? О ее мечтах?"
...
translate russian e10s02_2febb978:
    ...
    mc "Не вижу смысла в том, чтобы кто-то - не говоря уже о твоей семье - неуважительно относился к твоему мнению и указывал тебе..."
...
translate russian e10s02_b9ba7622:
    ...
    mc "Я слушал ее. Я могу рассказать, что Мин собиралась делать..."
...
translate russian e10s02_a27df2e1:
    ...
    md "Ты не понимаешь. Это наш семейный бизнес. \"Мин\" - это мы и есть, и Ын Су пойдет по пути, который я наметил."
...
translate russian e10s02_8c71e137:
    ...
    mes "Конечно, папа. [mcname], пойдём."
...
translate russian e10s02_79f9e729:
    ...
    mc "Позвольте мне внести ясность. Я принимаю близко к сердцу интересы вашей дочери."

# game/code/e10/e10s02.rpy:282
translate russian e10s02_2ea42706:

    # mc "We merely disagree at what is in her best interests."
    mc "Мы просто расходимся во мнениях относительно того, что отвечает ее наилучшим интересам."
...
translate russian e10s02_c18904f9:
    ...
    md "Я подыскал подходящую квартиру для моей дочери и для того, с кем она решит жить."
...
translate russian e10s02_6a25ef9e:
    ...
    mc "Вы упомянули подходящую ей работу. Полагаю, там положена разумная зарплата?"
...
translate russian e10s02_a0c77c71:
    ...
    md "На бумаге у нее будет солидная зарплата. Конечно, эти деньги будут реинвестированы в компанию, и она будет получать свою часть по семейной карте."
...
translate russian e10s02_0b74165e:
    ...
    mc "Это неприемлемо. Вы будете отслеживать и контролировать ее траты на дом и покупки?!"

# game/code/e10/e10s02.rpy:294
translate russian e10s02_f01a490b:

    # mes "*whisper* [mcname]! Can we discuss this later?"
    mes "*шепчет* [mcname]! Может мы обсудим это позже?"
...
translate russian e10s02_e3bebce1:
    ...
    mb "Уверен, мы понимаем, что - по-своему - ты пытаешься присмотреть за моей сестрой."
...
translate russian strings:
    ...
    new "Спроси ее, что она на самом деле думает по этому поводу"

    # game/code/e10/e10s02.rpy:224
    old "Tell them that she has other plans"
    new "Скажи, что у нее другие планы"
