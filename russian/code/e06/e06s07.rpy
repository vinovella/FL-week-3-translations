...
translate russian e06s07_af4b738d:
    ...
    sy "Последние штрихи. Я должна убедиться, что ты идеально одет, иначе..."

# game/code/e06/e06s07.rpy:21
translate russian e06s07_237168ae:

    # mc "You sound nervous. Is Lydia giving you a hard time?"
    mc "У тебя встревоженный голос. Лидия не дает тебе покоя?"
...
translate russian e06s07_dd4b315c:
    ...
    sy "Это, вероятно, самый важный день в твоей жизни - как ты можешь не нервничать?"
...
translate russian e06s07_4642bf3d:
    ...
    mc "Не пойми меня неправильно - мы с Лидией нервничали как черти в течение нескольких недель и старались сделать сегодняшний день идеальным."
...
translate russian e06s07_428a1cf2:
    ...
    mc "Сегодня мы просто будем наслаждаться и оставим все заботы на тебя и Мин."
...
translate russian e06s07_79493dae:
    ...
    mc "Я говорил тебе это, когда ты вызвалась быть моим лучшим \"человеком\"."
...
translate russian e06s07_9b00a4cc:
    ...
    sy "Правда, но я не думала, что Лидия переложит весь свой стресс на Мин... которая потом будет напрягать меня по каждой мелочи!"

# game/code/e06/e06s07.rpy:50
translate russian e06s07_9dc0b1be:

    # mc "Are you finally done fussing over my appearance yet?"
    mc "Ты наконец-то закончила возиться с моей внешностью?"
...
translate russian e06s07_b5ecac42:
    ...
    sy "Кроме того, он потом легко снимется."
...
translate russian e06s07_78f6d538:
    ...
    mh "...мы собрались здесь, чтобы ознаменовать законный союз и узы брака между Лидией Кокс и [mcname] Янгом."
...
translate russian e06s07_7d730ed8:
    ...
    mh "Пара выбрала свои собственные клятвы, которые они сейчас прочитают."
...
translate russian e06s07_64d63c9d:
    ...
    lc "Ты был первым мужчиной, к которому я прикоснулась в интимной обстановке."
...
translate russian e06s07_cd9eea02:
    ...
    lc "Я отдаю тебе свое сердце, свою душу и свою девственность."
...
translate russian e06s07_704c78aa:
    ...
    lc "Пока мы оба живы, ты единственный мужчина, с которым я буду получать сексуальное удовольствие - если только ты не прикажешь мне поступить иначе."
...
translate russian e06s07_55a83bed:
    ...
    lc "Я позабочусь о том, чтобы между нами не было разногласий."
...
translate russian e06s07_9d93a936:
    ...
    lc "Я клянусь, пока смерть не разлучит нас."
...
translate russian e06s07_ba8ffbc6:
    ...
    mc "Мм, да. Это может показаться не таким впечатляющим в сравнении, но..."
...
translate russian e06s07_2338a21d:
    ...
    mc "Лидия, ты - мой солнечный свет по утрам, моя любимая часть каждого дня и мой любимый спутник по ночам."

# game/code/e06/e06s07.rpy:179
translate russian e06s07_ab55d50f:

    # mc "Being with you is the best part of my existence."
    mc "Быть с тобой - это лучшая часть моей жизни."
...
translate russian e06s07_c8e29a0f:
    ...
    mc "Я люблю тебя безмерно и клянусь любить и дальше, даже если солнце погаснет."
...
translate russian e06s07_2abc3486:
    ...
    mc "Каждым своим сексуальным опытом я буду делиться с тобой."

# game/code/e06/e06s07.rpy:189
translate russian e06s07_0378952b:

    # mc "Every breath I take, I will do for you."
    mc "Каждый вздох, который я делаю, я делаю для тебя."
...
translate russian e06s07_233f0d4a:
    ...
    arj "*шепотом* Возможно, ты сможешь..."
...
translate russian e06s07_a3c130f8:
    ...
    mc "По-моему, звучит неплохо. Посмотрим, что из этого я помню."
...
translate russian e06s07_5525fcba:
    ...
    mc "Я обязуюсь использовать мою Королеву и мой гарем для удовлетворения своих сексуальных потребностей."
...
translate russian e06s07_9607a85e:
    ...
    mc "Заботиться об их комфорте и удовлетворять их сексуальные потребности - либо самостоятельно, либо с помощью членов моего гарема."
...
translate russian e06s07_0a69ae3b:
    ...
    mc "Любить и заботиться о каждом члене гарема до тех пор, пока они будут оставаться со мной."
...
translate russian e06s07_18f85531:
    ...
    mh "Согласна.{w} Полагаю, у нашей королевы есть дополнительные клятвы от имени гарема."
...
translate russian e06s07_608d4b1b:
    ...
    mh "Согласна.{w} Полагаю, у королевы есть дополнительные клятвы от имени гарема."
...
translate russian e06s07_ac729b7a:
    ...
    lc "Мы будем следовать указаниям нашей королевы и служить [mcname] в меру наших возможностей."
...
translate russian e06s07_9ce60b9c:
    ...
    lc "[mcname], мой Король, моя Любовь, мой Господин во всем. Этим кольцом я скрепляю наш союз."
...
translate russian e06s07_1bb05fdd:
    ...
    mh "Если есть кто-то, у кого есть причины, почему эти двое не должны вступить в брак, скажите сейчас или молчите вечно."
