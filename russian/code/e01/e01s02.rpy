...
translate russian e01s02_02444371:
    ...
    mc "Сюрприз, который требует, чтобы мы ехали поездом?"
...
translate russian e01s02_a76db968:
    ...
    sy "Я рада, что ты решил переехать ко мне. Я боялась, что ты уйдёшь к АмРоуз."
...
translate russian e01s02_d7e307e4:
    ...
    mc "Я шучу. Ты же знаешь, что ты для меня на первом месте."
...
translate russian e01s02_0cc2e585:
    ...
    sy "Ладно, хватит о пустяках. Сейчас я расскажу тебе об этом сюрпризе!"

# game/code/e01/e01s02.rpy:51
translate russian e01s02_39f27e8d:

    # mc "I'm all ears. {w}Train it coming!"
    mc "Слушаю внимательно.{w} Поезд прибывает!"
...
translate russian e01s02_c8261eaf:
    ...
    sy "Конечно, знаешь! Что бы ты хотел сделать прямо сейчас, если бы не занимался этим?"

# game/code/e01/e01s02.rpy:68
translate russian e01s02_aad729bb:

    # mc "Play some video games and take a nap?"
    mc "Поиграть в видеоигры и поспать?"
...
translate russian e01s02_a15b4a11:
    ...
    sy "Что бы ты сделал, выиграв несколько сотен миллионов долларов?"

# game/code/e01/e01s02.rpy:75
translate russian e01s02_b68059e8:

    # mc "Isn't it supposed to be just a million dollars?"
    mc "Разве это не должен быть простой миллион долларов?"
...
translate russian e01s02_9cef3f26:
    ...
    sy "Да, но если ты работаешь на достойной работе с учетом повышения зарплаты, инфляции и всего прочего - я удивлюсь, если ты не заработаешь несколько миллионов до того, как тебе исполнится семьдесят."
...
translate russian e01s02_d45a66d7:
    ...
    mc "Хорошо, хорошо. Итак, я играю в лото или иду в казино и срываю джекпот."
...
translate russian e01s02_0c1fa20a:
    ...
    sy "Что-то вроде того. Достаточно денег, чтобы больше никогда не работать."
...
translate russian e01s02_d094470a:
    ...
    mc "По уму, я попрошу адвоката получить его за меня, что даст мне несколько месяцев, прежде чем мошенники поймут, кто я такой."
...
translate russian e01s02_b40d48cd:
    ...
    mc "Я хочу сказать... это похоже на ад."
...
translate russian e01s02_3498fe23:
    ...
    mc "Серьезно, я понял, что могу делать все, что захочу. Так что я так и поступаю."
...
translate russian e01s02_e9770062:
    ...
    sy "Словно он тебе нужен. В любом случае, я конфисковала его в исследовательских целях."
...
translate russian e01s02_cccc4977:
    ...
    mc "Ладно, ясно. В чем заключается первая часть твоего генерального плана."
...
translate russian e01s02_420e1232:
    ...
    sy "Ты, конечно же. Теперь, когда ты мой, я могу перейти ко второй части."
...
translate russian e01s02_764b69bb:
    ...
    sy "Мы откроем свою порностудию!!!"
...
translate russian e01s02_5ff784b2:
    ...
    sy "Тссс. Расслабь свой мозг и слушай."
...
translate russian e01s02_c0c6d182:
    ...
    sy "Как я уже сказала, мы откроем свою порностудию."
...
translate russian e01s02_cccd224a:
    ...
    sy "Я буду руководить всем за кулисами, а ты будешь главным действующим персонажем."
...
translate russian e01s02_d3c994b6:
    ...
    sy "Признай это, дорогой. Ты и так уже стал им."
...
translate russian e01s02_7627de93:
    ...
    mc "Наверное, у меня есть несколько друзей, которые могут согласиться на роль..."
...
translate russian e01s02_27728f0f:
    ...
    sy "О, это как раз то, что нужно! У меня есть несколько отличных идей по выявлению новых талантов."
...
translate russian e01s02_19c51089:
    ...
    sy "Не пойми меня неправильно - мне нравится смотреть фотографии и видео, которые прислали люди."
...
translate russian e01s02_ca1fbc38:
    ...
    mc "Я был бы не против увидеть больше таких... но это неправильно, не так ли?"
...
translate russian e01s02_7d0d944d:
    ...
    sy "Это, конечно, здорово, но настоящая ценность - в метаданных."
...
translate russian e01s02_880d2eb6:
    ...
    sy "Метаданные. Что и кто сделал. Где это сделали. Что они сделали. И так далее."
...
translate russian e01s02_c6435fd2:
    ...
    mc "Но мы все использовали псевдонимы, и я предполагаю, что некоторые игроки использовали маски или..."
...
translate russian e01s02_040e7566:
    ...
    sy "Да, но, допустим, ты знаешь, что в определенном кабинете, баре или даже в аудитории есть кто-то..."

# game/code/e01/e01s02.rpy:219
translate russian e01s02_b180d10e:

    # sy "And that person did a specific fetish that you wanted..."
    sy "И этот человек занимался конкретным фетишем, который ты хотел..."
...
translate russian e01s02_479e5112:
    ...
    sy "Возможно, я не смогу сказать, кто это сделал, но если ты пойдешь туда..."

# game/code/e01/e01s02.rpy:223
translate russian e01s02_1bf2a72b:

    # mc "I might be able to recognize the person some other way."
    mc "Возможно, я смогу узнать человека каким-то другим способом."
...
translate russian e01s02_7a974976:
    ...
    sy "Я провела несколько исследований в Интернете, обратилась к различным базам данных..."
...
translate russian e01s02_aa1c2593:
    ...
    sy "Поэтому я и жалею, что вы не дали мне скопировать базу данных Фетиш Локатора."

# game/code/e01/e01s02.rpy:262
translate russian e01s02_22cfad4b:

    # mc "You did, didn't you?"
    mc "Ты ведь сделала это, не так ли?"
...
translate russian e01s02_0c18235f:
    ...
    sy "Я избавилась от всего, что можно было бы использовать против кого-либо."

# game/code/e01/e01s02.rpy:274
translate russian e01s02_64565a28:

    # mc "AmRose is going to be pissed when she finds out."
    mc "АмРоуз будет в бешенстве, если узнает."
...
translate russian e01s02_9549a2df:
    ...
    sy "Все фотографии, видео и информация об игроках была удалена или перезаписана. Клянусь!"

# game/code/e01/e01s02.rpy:280
translate russian e01s02_f3c24e07:

    # mc "So, what did you keep?"
    mc "Тогда что ты сохранила?"
...
translate russian e01s02_a405cbb3:
    ...
    sy "Метаданные. Местоположение. Расплывчатая информация. Ничего, что позволило бы установить личность."

# game/code/e01/e01s02.rpy:286
translate russian e01s02_3afef519:

    # mc "Why would you keep that?"
    mc "Зачем это хранить?"
...
translate russian e01s02_82a424e4:
    ...
    sy "Я не смогла просто так оставить все это. Мне нужны эти данные для реализации моих дальнейших планов."

# game/code/e01/e01s02.rpy:292
translate russian e01s02_deca5f78:

    # mc "So, what exactly are you proposing?"
    mc "Так что конкретно ты предлагаешь?"
...
translate russian e01s02_d1c1e9db:
    ...
    sy "Мы вместе работаем над созданием собственной порностудии. Я определяю места, куда тебе лучше всего пойти, чтобы встретиться с людьми, а ты творишь свою магию."
...
translate russian e01s02_4b8e92a4:
    ...
    mc "Ты хочешь, чтобы мы сделали что?!"
...
translate russian e01s02_a064a748:
    ...
    mc "Мы НЕ будем снимать секс сцены без их ведома!!! Это ужасно!!!"
...
translate russian e01s02_f9476b57:
    ...
    sy "Я такого не говорила. Конечно, мы договорились бы с ними о псевдонимах и о формах согласия."
...
translate russian e01s02_e0e15ae9:
    ...
    mc "Это хорошая идея. Фетишей очень много, но они не являются мейнстримом."
...
translate russian e01s02_b7dbe3cb:
    ...
    sy "Именно, мы можем стать единственным магазином для людей с любыми фетишами!"
...
translate russian e01s02_993d115f:
    ...
    mc "И если бы мы смогли собрать их все вместе, то получили бы нечто вроде великого наследия."

# game/code/e01/e01s02.rpy:357
translate russian e01s02_8cae717a:

    # sy "Now there's an idea. The Citizen Kane of porn."
    sy "А это идея. Этакий \"Гражданин Кейн\" порнографии."
...
translate russian e01s02_23e692ac:
    ...
    mc "*хихикает* Может быть, нам даже удастся получить премию за лучшую картину и премию eXXXstacy."

# game/code/e01/e01s02.rpy:363
translate russian e01s02_fa37650d:

    # sy "There you go. We have our stretch goal."
    sy "И так. Мы достигли нашей цели."
...
translate russian e01s02_dbc038bf:
    ...
    sy "Ну, когда я её смотрела, я представляла, как мы всё это делаем."
...
translate russian e01s02_807cc3c6:
    ...
    mc "Возражаю? Это звучит потрясно."
...
translate russian e01s02_2af97179:
    ...
    sy "Должно быть, ты уже догадался о сюрпризе."
...
translate russian strings:
    ...
    new "Стейси и [mcname] скоро вернутся!"
