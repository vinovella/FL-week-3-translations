...
translate russian strings:
    ...
    new "Не удалось сохранить сохранить скриншот как %s."
    ...
    new "У этого аккаунта нет прав записывать лог обновления."

    # renpy/common/00updater.rpy:746
    old "Could not verify update signature."
    new "Не удалось верифицировать подпись обновления."
